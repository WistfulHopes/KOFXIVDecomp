...
void Scaleform::GFx::IMEManagerBase::OnMouseDown(Scaleform::GFx::Movie * pmovie, long buttonsState, Scaleform::GFx::InteractiveObject * pitemUnderMousePtr); // 0x1403656A0
void Scaleform::GFx::IMEManagerBase::OnMouseUp(Scaleform::GFx::Movie * pmovie, long buttonsState, Scaleform::GFx::InteractiveObject * pitemUnderMousePtr); // 0x14002E7C0
void Scaleform::GFx::IMEManagerBase::DoFinalize(); // 0x140365610
void Scaleform::GFx::IMEManagerBase::EnableIME(bool enable); // 0x140365640void __fastcall Scaleform::GFx::IMEManagerBase::DoFinalize(Scaleform::GFx::IMEManagerBase *this)
{
  Scaleform::GFx::TextField *pObject; // rcx

  this->OnFinalize(this);
  pObject = this->pTextField.pObject;
  if ( pObject )
    Scaleform::RefCountNTSImpl::Release(pObject);
  this->pTextField.pObject = 0i64;
}

void __fastcall Scaleform::GFx::IMEManagerBase::EnableIME(Scaleform::GFx::IMEManagerBase *this, bool enable)
{
  bool IMEDisabled; // al
  ...
  if ( IMEDisabled == enable )
  {
    ...
    ((void (__fastcall *)(Scaleform::GFx::IMEManagerBase *))this->OnEnableIME)(this);
  }
}

bool __fastcall Scaleform::GFx::TextField::IsIMEEnabled(Scaleform::GFx::TextField *this)
{
  return (this->Flags & 0x800) == 0 && !Scaleform::GFx::TextField::IsReadOnly(this) && (this->Flags & 4) == 0;
}

void __fastcall Scaleform::GFx::IMEManagerBase::OnMouseDown(
        Scaleform::GFx::IMEManagerBase *this,
        Scaleform::GFx::Movie *pmovie,
        __int64 buttonsState,
        Scaleform::GFx::InteractiveObject *pitemUnderMousePtr)
{
  Scaleform::GFx::TextField *pObject; // rax
  Scaleform::GFx::TextField *v7; // rcx

  if ( ((unsigned __int8 (__fastcall *)(Scaleform::GFx::IMEManagerBase *, Scaleform::GFx::Movie *, __int64))this->IsMovieActive)(
         this,
         pmovie,
         buttonsState) )
  {
