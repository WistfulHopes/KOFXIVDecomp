...
long long Scaleform::GFx::FileOpener::GetFileModifyTime(const char * purl); // 0x1402EDC90
Scaleform::File * Scaleform::GFx::FileOpener::OpenFileEx(const char * pfilename, Scaleform::Log * plog, long flags, long modes); // 0x1402EDD70__int64 __fastcall Scaleform::GFx::FileOpener::GetFileModifyTime(Scaleform::GFx::FileOpener *this, const char *purl)
{
  bool FileStat; // al
  __int64 v3; // rdi
  void *v4; // rbx
  bool v5; // si
  Scaleform::String path; // [rsp+20h] [rbp-38h] BYREF
  Scaleform::FileStat pfileStat; // [rsp+28h] [rbp-30h] BYREF

  Scaleform::String::String(&path, purl);
  FileStat = Scaleform::SysFile::GetFileStat(&pfileStat, &path);
  v3 = -1i64;
  v4 = (void *)(path.HeapTypeBits & 0xFFFFFFFFFFFFFFFCui64);
  v5 = FileStat;
...
Scaleform::RefCountVImpl *__fastcall Scaleform::GFx::FileOpener::OpenFileEx(
        ...
        int modes)
{
  Scaleform::File *v7; // rax
  Scaleform::RefCountVImpl *v8; // rbx

  v7 = this->OpenFile(this, pfilename, (unsigned int)flags, (unsigned int)modes);
  v8 = (Scaleform::RefCountVImpl *)v7;
  if ( v7 && !v7->GetErrorCode(v7) )
    return v8;
  if ( plog )
