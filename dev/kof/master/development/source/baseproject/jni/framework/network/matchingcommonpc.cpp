...
std::piecewise_construct_t std::piecewise_construct; // 0x140889019
bool Fw::MatchingCommon::Initialize(Fw::HeapMemory & rHeap); // 0x140048360//decompilation failure at 140889019!
char __fastcall Fw::MatchingCommon::Initialize(Fw::HeapMemory *rHeap)
{
  Fw::HeapMemory *v1; // rcx
  Fw::MatchingTargetCallbackHandler *v3; // [rsp+30h] [rbp+8h]

  if ( Fw::MatchingCommon::m_Initialized )
    return 1;
  *((_DWORD *)&Fw::MatchingTarget::m_RoomId.m_steamid.m_comp + 1) &= 0xFF0FFFFF;
  ...
  v3 = (Fw::MatchingTargetCallbackHandler *)operator new(0x120ui64);
  Fw::MatchingTargetCallbackHandler::MatchingTargetCallbackHandler(v3);
  if ( !Fw::NetTransceiver::m_IsStartupFlag )
  {
    Fw::NetTransceiver::m_IsStartupFlag = 1;
    Fw::NetTransceiver::m_IsStartupFlag2 = 1;
    if ( Fw::VoiceChat::Initialize(v1) )
    {
      Fw::MatchingCommon::m_Initialized = 1;
      return 1;
    }
  }
  return 0;
