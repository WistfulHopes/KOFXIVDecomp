...
std::piecewise_construct_t std::piecewise_construct; // 0x14088901A
void Fw::MatchingSystem::SetRoomMemberName(CSteamID memberId, const char * name); // 0x1400483E0
bool Fw::MatchingSystem::JoinRoom(CSteamID roomId, bool password); // 0x140048450
void Fw::MatchingSystem::setStateMute(char idx, bool flag); // 0x1400484B0
long Fw::MatchingSystem::getCntConectedUser(); // 0x140048520//decompilation failure at 14088901A!
char __fastcall Fw::MatchingSystem::JoinRoom(CSteamID roomId, bool password)
{
  __int64 v2; // rdx
  __int64 v3; // rax
  ...
  (*(void (__fastcall **)(_QWORD, CSteamID::SteamID_t))(**(_QWORD **)(v3 + 32) + 112i64))(
    *(_QWORD *)(v3 + 32),
    roomId.m_steamid);
  return 1;
}

void __fastcall Fw::MatchingSystem::SetRoomMemberName(CSteamID memberId, const char *name)
{
  ...
  do
  {
    if ( *p_memberId == memberId.m_steamid.m_comp )
      AgString::operator=(&p_npId->handle, name);
...
__int64 __fastcall Fw::MatchingSystem::getCntConectedUser()
{
  signed __int64 v0; // rbx

  EnterCriticalSection((LPCRITICAL_SECTION)&Fw::NetTransceiver::m_SendMutex);
  v0 = Fw::NetTransceiver::m_UserInfo._Mypair._Myval2._Mylast - Fw::NetTransceiver::m_UserInfo._Mypair._Myval2._Myfirst;
  LeaveCriticalSection((LPCRITICAL_SECTION)&Fw::NetTransceiver::m_SendMutex);
  return (unsigned int)v0;
}

void __fastcall Fw::MatchingSystem::setStateMute(char idx, bool flag)
{
  Fw::VoiceChat::VoiceQos *v3; // rbx
  int v4; // eax
  int v5; // eax
  ...
  if ( v3->bConnected )
  {
    v4 = Mtx_lock((_Mtx_internal_imp_t *)&Fw::VoiceChat::m_VoiceChatMutex);
    if ( v4 )
      std::_Throw_C_error(v4);
    v3->bStateMute = flag;
    v5 = Mtx_unlock((_Mtx_internal_imp_t *)&Fw::VoiceChat::m_VoiceChatMutex);
    if ( v5 )
