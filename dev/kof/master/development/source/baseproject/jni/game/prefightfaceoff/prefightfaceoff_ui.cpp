...
#include "dev/kof/master/development/source/baseproject/jni/game/prefightfaceoff/prefightfaceoff_ui.h"
...
std::piecewise_construct_t std::piecewise_construct; // 0x1408A061F
PreFightFaceOff::UI::~UI(); // 0x1401A4760
bool PreFightFaceOff::UI::create(); // 0x1401A47E0
void PreFightFaceOff::UI::draw(); // 0x1401A49B0//decompilation failure at 1408A061F!
void __fastcall PreFightFaceOff::UI::~UI(PreFightFaceOff::UI *this)
{
  extension::AsyncContent<Image> *m_ptr; // rcx
  extension::BasicFutureObject<Image,extension::FutureImageOption>::Body *v3; // rcx

  this->__vftable = (PreFightFaceOff::UI_vtbl *)&PreFightFaceOff::UI::`vftable';
  ...
  this->m_bResourcesCreated = 0;
  this->m_bError = 0;
  v3 = this->m_image.m_body.m_ptr;
  if ( v3
  ...
  this->__vftable = (PreFightFaceOff::UI_vtbl *)&ErrorChecker::`vftable';
}

char __fastcall PreFightFaceOff::UI::create(PreFightFaceOff::UI *this)
{
  extension::AsyncContent<Image> *m_ptr; // rcx
  extension::BasicFutureObject<Image,extension::FutureImageOption>::AssetCache *v3; // rcx
  extension::BasicFutureObject<Image,extension::FutureImageOption>::Body *v4; // r8
  extension::BasicFutureObject<Image,extension::FutureImageOption>::Body *v5; // rdx
  extension::BasicFutureObject<Image,extension::FutureImageOption>::Body *v6; // rcx
  char *Ptr; // rcx
  char *v8; // rax
  extension::RefCountablePtr<extension::BasicFutureObject<Image,extension::FutureImageOption>::Body> v10; // [rsp+28h] [rbp-70h] BYREF
  ...
  std::string::assign(&_Right, "ui/battle_ui/PreFightFaceOff/PreFightFaceOff.obm", 0x30ui64);
  ...
  v6 = this->m_image.m_body.m_ptr;
  this->m_image.m_body.m_ptr = v5;
  if ( v6 )
  {
    if ( _InterlockedExchangeAdd64(
           (volatile signed __int64 *)&v6->m_refCount.m_ptr->m_sharedCount,
           0xFFFFFFFFFFFFFFFFui64) == 1 )
      ((void (__fastcall *)(extension::BasicFutureObject<Image,extension::FutureImageOption>::Body *, __int64))v6->~RefCountableWeakSupportBase)(
        v6,
        1i64);
    v4 = v10.m_ptr;
  }
...
void __fastcall PreFightFaceOff::UI::draw(PreFightFaceOff::UI *this)
{
  GraphicsOpt *v2; // rdi
  float v3; // xmm6_4
  float v4; // xmm7_4
  ...
  if ( !this->isError(this) && this->m_bResourcesCreated )
  {
    v2 = *(GraphicsOpt **)(*(_QWORD *)&AppMain::pApp + 112i64);
    v3 = (float)((float)*(int *)(*(_QWORD *)&AppMain::pApp + 32i64) / 1080.0) * 164.0;
    v4 = (float)*(int *)(*(_QWORD *)&AppMain::pApp + 32i64) - v3;
    scalY = v3 * 0.03125;
    scalX = (float)*(int *)(*(_QWORD *)&AppMain::pApp + 28i64) * 0.03125;
    GraphicsOpt::lock(v2);
    g = v2->g;
    v9 = g->m_bPreDrawMode == 0;
    g->m_Operator = 0;
    g->m_SrcRatio = 255;
    g->m_DstRatio = 255;
    if ( v9 )
    ...
    v10 = (Image *)extension::BasicFutureObject<extension::GFXIMovieData,void>::operator->(
                     ...
                     v7);
    GraphicsOpt::drawConv(v2, v10, 0.0, v4, &pConv, scalX, scalY, 0.0, 0);
