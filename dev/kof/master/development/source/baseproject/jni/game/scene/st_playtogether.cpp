...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5EAF0
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B21
void LoadCompleteEventPlayTogether(); // 0x1401C17F0
void AppMain::ST_PlayTogetherInit(); // 0x1401D01F0
void AppMain::ST_PlayTogetherLoop(); // 0x1401D0470
void AppMain::ST_PlayTogetherDraw(); // 0x1401C06B0//decompilation failure at 140A5EAF0!
//decompilation failure at 1408A0B21!
...
void __fastcall AppMain::ST_PlayTogetherInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  UserGameOperation *v6; // rax
  GfxManager *v7; // rax
  extension::gfxi_detail::MovieProxy *m_ptr; // rcx
  extension::gfxi_detail::MovieProxy *v9; // rcx
  __int64 v10; // rax
  __int64 v11; // rcx
  ...
  GfxManager::LoadRequest(v5, FILE_01_UI_MENU_PLAYTOGETHER, LoadCompleteEventOnlineTraining, a4);
  ...
  if ( v7->m_GFXMovie.m_movieProxy.m_ptr )
  {
    v7->m_GFXMovie.m_movieProxy.m_ptr->m_bAdvance = 1;
    if ( v7->m_GFXMovie.m_movieProxy.m_ptr )
      v7->m_GFXMovie.m_movieProxy.m_ptr->m_bRender = 1;
  }
  if ( !v7 )
  {
    soundName.m_sharedBuffer.m_ptr = (extension::exsound_detail::SoundNameRegistry::NameBuffer *)operator new(0x108ui64);
  ...
  if ( v7->m_GFXMovieBG.m_movieProxy.m_ptr )
  {
    m_ptr = v7->m_GFXMovieBG.m_movieProxy.m_ptr;
    if ( m_ptr )
      m_ptr->m_bAdvance = 1;
    v9 = v7->m_GFXMovieBG.m_movieProxy.m_ptr;
    if ( v9 )
      v9->m_bRender = 1;
  }
  else
  {
    GfxManager::LoadRequestBG(v7);
  }
  SyncMenuImage::Load(
    &this->m_SyncMenuBG,
...
LABEL_28:
  ...
  this->m_FuncST = 142;
  this->m_FuncBT = 143;
  AppMain::SceneFunc(this, 142);
  this->m_FuncExit = 141;
}

void __fastcall AppMain::ST_PlayTogetherLoop(AppMain *this)
{
  GfxManager *v2; // rax
  GfxManager *v3; // rbp
  volatile signed __int64 *m_ptr; // rbx
  GfxManager *v5; // rax
  ...
  GameDataInfo *v16; // rax
  GameDataInfo *v17; // rax
  GameDataInfo *v18; // rax
  GameDataInfo *v19; // rax
  GameDataInfo *v20; // rax
  extension::gfxi_detail::MovieProxy *v21; // [rsp+50h] [rbp+8h]
  extension::gfxi_detail::MovieProxy *v22; // [rsp+50h] [rbp+8h]
  extension::gfxi_detail::MovieProxy *v23; // [rsp+50h] [rbp+8h]
  GfxManager *v24; // [rsp+58h] [rbp+10h]
  GfxManager *v25; // [rsp+58h] [rbp+10h]

  v2 = GfxManager::instance;
  if ( !GfxManager::instance )
  {
    v21 = (extension::gfxi_detail::MovieProxy *)operator new(0x108ui64);
    GfxManager::GfxManager((GfxManager *)v21);
    GfxManager::instance = v2;
  }
  v3 = v2;
  if ( !v2 )
  {
    v22 = (extension::gfxi_detail::MovieProxy *)operator new(0x108ui64);
    GfxManager::GfxManager((GfxManager *)v22);
    GfxManager::instance = v2;
  }
  m_ptr = (volatile signed __int64 *)v2->m_GFXMovie.m_movieProxy.m_ptr;
  v23 = v2->m_GFXMovie.m_movieProxy.m_ptr;
  if ( v2->m_GFXMovie.m_movieProxy.m_ptr )
  {
    _InterlockedExchangeAdd64(m_ptr, 1ui64);
    m_ptr = (volatile signed __int64 *)v23;
  }
  ...
  if ( v3->m_bQuitGFXMovie )
  {
    ...
    v7 = v5->m_MenuCursor[11];
    if ( v5->m_QuitResultCode == RESULT_CODE_CANCEL )
    {
      this->iReserveScene = -1;
      this->m_FadeST = 16;
      this->m_FuncST = 0;
      this->m_FadeExitFunc = 141;
    ...
    if ( v7 )
    {
      ...
      if ( v8 )
      {
        ...
        if ( v9 )
        {
          ...
          Instance->m_GameMode[Instance->m_GameModeIndex] = GAME_MODE_ONLINETRAINING;
          v11 = GameDataInfo::getInstance();
          v11->m_GameRule[v11->m_GameRuleIndex] = GAME_RULE_SINGLE;
          v12 = GameDataInfo::getInstance();
          GameDataInfo::SetDefaultSettingSaveData(v12);
          v13 = 156;
          goto LABEL_27;
        }
        this->MatchingGameRule = GAME_RULE_PARTY;
        v14 = GameDataInfo::getInstance();
        v14->m_GameMode[v14->m_GameModeIndex] = GAME_MODE_FREEMATCH;
        v15 = GameDataInfo::getInstance();
        v15->m_GameRule[v15->m_GameRuleIndex] = GAME_RULE_PARTY;
      }
      else
      {
        this->MatchingGameRule = GAME_RULE_SINGLE;
        v16 = GameDataInfo::getInstance();
        v16->m_GameMode[v16->m_GameModeIndex] = GAME_MODE_FREEMATCH;
        v17 = GameDataInfo::getInstance();
        v17->m_GameRule[v17->m_GameRuleIndex] = GAME_RULE_SINGLE;
      }
    }
    else
    {
      ...
      v18->m_GameMode[v18->m_GameModeIndex] = GAME_MODE_FREEMATCH;
      v19 = GameDataInfo::getInstance();
      v19->m_GameRule[v19->m_GameRuleIndex] = GAME_RULE_TEAM;
    }
    v20 = GameDataInfo::getInstance();
    GameDataInfo::SetDefaultSettingSaveData(v20);
    v13 = 136;
LABEL_27:
    AppMain::setNonFadeSTExit(this, v13, 141);
  }
LABEL_28:
  if ( m_ptr )
  {
    if ( _InterlockedExchangeAdd64(m_ptr, 0xFFFFFFFFFFFFFFFFui64) == 1 )
    {
