...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5D590
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B0B
void AppMain::ST_GalleryInit(); // 0x1401C2800
void AppMain::ST_GalleryExit(); // 0x1401C2910
void AppMain::ST_GalleryLoop(); // 0x1401C29C0
void AppMain::ST_GalleryDraw(); // 0x1401C2D60//decompilation failure at 140A5D590!
//decompilation failure at 1408A0B0B!
void __fastcall AppMain::ST_GalleryDraw(AppMain *this)
{
  Graphics *v2; // rcx
  int v3; // er8
  int v4; // er9
  ...
  MovieData *v14; // [rsp+60h] [rbp+8h]
  GfxManager *v15; // [rsp+60h] [rbp+8h]
  ...
  if ( (unsigned int)(v6->m_bPlay - 1) > 2 )
  {
  ...
  else
  {
    ...
    MovieData::Draw(v9, this->m_pRender, v10, v11, w, h);
  }
  ...
  extension::GFXIMovieStack::render(v13);
  Graphics::drawStack(this->g->g);
}

void __fastcall AppMain::ST_GalleryExit(AppMain *this, bool a2)
{
  MovieData *v3; // rax
  GfxManager *v4; // rax
  MovieData *v5; // [rsp+40h] [rbp+8h]
  GfxManager *v6; // [rsp+40h] [rbp+8h]

  v3 = MovieData::movieData;
  if ( !MovieData::movieData )
  {
    v5 = (MovieData *)operator new((unsigned int)((_DWORD)MovieData::movieData + 72));
    MovieData::MovieData(v5);
    MovieData::movieData = v3;
  }
  MovieData::Finalize(v3, a2);
  extension::SoundList::dispose(&this->m_Snd_Lists[5]);
  extension::SoundList::dispose(&this->m_Snd_Lists[1]);
  anonymous_namespace_::SoundVolumeModulation::SetVolumeModulation(GROUP_BGM, 1.0, 0.2);
  ...
  GfxManager::ReleaseGFXMovie(v4, 0);
}

void __fastcall AppMain::ST_GalleryInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  MovieData *v6; // rax
  UserGameOperation *v7; // rax
  GfxManager *v8; // [rsp+40h] [rbp+8h]
  MovieData *v9; // [rsp+40h] [rbp+8h]
  ...
  GfxManager::LoadRequest(v5, FILE_11_GALLERY, 0i64, a4);
  v6 = MovieData::movieData;
  if ( !MovieData::movieData )
  {
  ...
  v6->m_bPlay = STOP;
  *(_QWORD *)&v6->m_requestMovie = -1i64;
  *(_WORD *)&v6->m_Audio = 0;
  v6->m_Telop = 0;
  v6->m_TelopInfo = 0i64;
  *(_QWORD *)&v6->m_TelopNum = 0i64;
  v6->m_TelopCurrent = -1;
  v6->m_timeOut = 0;
  ...
  this->m_FuncST = 49;
  this->m_FuncBT = 50;
  AppMain::SceneFunc(this, 49);
  this->m_FuncExit = 51;
}

void __fastcall AppMain::ST_GalleryLoop(AppMain *this)
{
  GfxManager *v2; // rsi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
  ...
  extension::GFXIMovieStack *v14; // rax
  EasyIndicator *v15; // rdi
  GfxManager *v16; // [rsp+30h] [rbp-248h]
  GfxManager *v17; // [rsp+30h] [rbp-248h]
  MovieData *v18; // [rsp+30h] [rbp-248h]
  MovieData *v19; // [rsp+30h] [rbp-248h]
  GfxManager *v20; // [rsp+30h] [rbp-248h]
  extension::SoundManager *v21; // [rsp+30h] [rbp-248h]
  MovieData *v22; // [rsp+30h] [rbp-248h]
  Scaleform::GFx::Value presult; // [rsp+38h] [rbp-240h] BYREF
  __int64 v24; // [rsp+68h] [rbp-210h]
  Scaleform::GFx::Value ptr[10]; // [rsp+70h] [rbp-208h] BYREF
  ...
  if ( !MovieData::movieData )
  {
    v18 = (MovieData *)operator new((unsigned int)((_DWORD)MovieData::movieData + 72));
  ...
  if ( MovieData::IsPlayEnd(v7) )
  {
    ...
    m_ptr = v8->m_GFXMovie.m_movieProxy.m_ptr;
    if ( Scaleform::GFx::Movie::IsAvailable(v8->m_GFXMovie.m_movieProxy.m_ptr->m_movie.pObject, "_root.RemoveMovie") )
      Scaleform::GFx::Movie::Invoke(m_ptr->m_movie.pObject, "_root.RemoveMovie", &presult, ptr, 0);
    ...
    extension::SoundManager::stopBGM(v10, 1.0);
    v12 = MovieData::movieData;
    if ( !MovieData::movieData )
    {
      v22 = (MovieData *)operator new((unsigned int)((_DWORD)MovieData::movieData + 72));
      MovieData::MovieData(v22);
      MovieData::movieData = v12;
    }
    MovieData::Finalize(v12, v11);
    v13 = UserGameOperation::Instance();
    UserGameOperation::clear(v13);
    v14 = extension::GFXIMovieStack::Instance();
    extension::GFXIMovieStack::advance(v14, 0.0);
  ...
  {
    v15 = EasyIndicator::instance;
    if ( !EasyIndicator::instance )
    {
      v15 = (EasyIndicator *)operator new(0x150ui64);
      memset(v15->m_IndicatorStack, 0, sizeof(v15->m_IndicatorStack));
      v15->m_Image = 0i64;
      v15->m_DrawCount = 0;
      EasyIndicator::instance = v15;
    }
    EasyIndicator::RequestDraw(v15, 1760 * GAME_SCREEN_WIDTH / 1920, 920 * GAME_SCREEN_HEIGHT / 1080, TYPE_LOADING);
  }
