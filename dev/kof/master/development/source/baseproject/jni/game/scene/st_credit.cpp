...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5CFF0
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B03
void AppMain::ST_CreditInit(); // 0x1401C0850
void AppMain::ST_CreditLoop(); // 0x1401C0AA0
void AppMain::ST_CreditDraw(); // 0x1401C0BF0//decompilation failure at 140A5CFF0!
//decompilation failure at 1408A0B03!
...
void __fastcall AppMain::ST_CreditInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  GfxManager *v6; // rax
  ...
  extension::exsound_detail::SoundNameRegistry::NameBuffer *v11; // rbx
  extension::exsound_detail::SoundNameRegistry::NameBuffer *v12; // r9
  char *v13; // r8
  char *m_str; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_09_CREDITS, 0i64, a4);
  ...
  AppMain::UnlockGallery(this, GALLERY_ID_END_CREDIT, 1);
  v10 = (volatile signed __int64 *)s_soundIndex.m_keys[101].m_sharedBuffer.m_ptr;
  soundName.m_sharedBuffer.m_ptr = s_soundIndex.m_keys[101].m_sharedBuffer.m_ptr;
  if ( s_soundIndex.m_keys[101].m_sharedBuffer.m_ptr )
  {
    v10 = (volatile signed __int64 *)s_soundIndex.m_keys[101].m_sharedBuffer.m_ptr->m_refCount.m_ptr;
    _InterlockedExchangeAdd64(v10 + 2, 1ui64);
  }
  p_soundName = &soundName;
  AppMain::Sound_BGMPlay_GetSoundHashKey((AppMain *)v10, &result);
  v11 = result.m_sharedBuffer.m_ptr;
  if ( !result.m_sharedBuffer.m_ptr )
    goto LABEL_20;
  v12 = soundName.m_sharedBuffer.m_ptr;
  v13 = soundName.m_sharedBuffer.m_ptr ? soundName.m_sharedBuffer.m_ptr->m_str : 0i64;
  m_str = result.m_sharedBuffer.m_ptr->m_str;
  v15 = v13 - result.m_sharedBuffer.m_ptr->m_str;
  do
  {
...
LABEL_20:
  ...
  if ( v12
    && _InterlockedExchangeAdd64(
         ...
         0xFFFFFFFFFFFFFFFFui64) == 1 )
  {
    ((void (__fastcall *)(extension::exsound_detail::SoundNameRegistry::NameBuffer *, __int64))v12->~RefCountableWeakSupportBase)(
      v12,
      1i64);
  }
  if ( this->m_iFadeAlpha )
  {
    ...
    v18 = 1000 * this->m_iFadeColor.s.a;
    this->m_iFadeAlpha = v18;
    this->m_iFadeRate = v18 / 10;
    this->m_bFadeLock = 0;
    this->m_FuncFT = 171;
  }
  ...
  this->m_FuncST = 122;
  this->m_FuncBT = 123;
  AppMain::SceneFunc(this, 122);
  this->m_FuncExit = 121;
}

void __fastcall AppMain::ST_CreditLoop(AppMain *this)
{
  GfxManager *v2; // rax
  GfxManager *v3; // rdi
  extension::GFXIMovieStack *v4; // rax
  extension::SoundManager *v5; // rax
  GfxManager *v6; // [rsp+48h] [rbp+10h]
  GfxManager *v7; // [rsp+48h] [rbp+10h]
  extension::SoundManager *v8; // [rsp+48h] [rbp+10h]
  ...
  if ( v3->m_bQuitGFXMovie )
  {
    ...
    extension::SoundManager::stopBGM(v5, 0.5);
    this->iReserveScene = -1;
    this->m_FadeST = 36;
    this->m_FuncST = 0;
    this->m_FadeExitFunc = 121;
