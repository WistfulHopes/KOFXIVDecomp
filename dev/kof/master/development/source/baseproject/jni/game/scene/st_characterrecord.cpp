...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5CED0
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B01
void AppMain::ST_CharacterRecordInit(); // 0x1401C04C0
void AppMain::ST_CharacterRecordLoop(); // 0x1401C05B0
void AppMain::ST_CharacterRecordDraw(); // 0x1401C06B0//decompilation failure at 140A5CED0!
//decompilation failure at 1408A0B01!
...
void __fastcall AppMain::ST_CharacterRecordInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_17_CHARA_RECORD, 0i64, a4);
  ...
  this->m_FuncST = 70;
  this->m_FuncBT = 71;
  AppMain::SceneFunc(this, 70);
  this->m_FuncExit = 69;
}

void __fastcall AppMain::ST_CharacterRecordLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
