...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5DE90
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B14
void AppMain::ST_MissionTrialInit(); // 0x1401CAD60
void AppMain::ST_MissionTrialLoop(); // 0x1401CB010
void AppMain::ST_MissionTrialDraw(); // 0x1401C06B0//decompilation failure at 140A5DE90!
//decompilation failure at 1408A0B14!
...
void __fastcall AppMain::ST_MissionTrialInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  extension::gfxi_detail::MovieProxy *m_ptr; // rcx
  extension::gfxi_detail::MovieProxy *v7; // rdx
  ...
  {
    v5->m_GFXMovie.m_movieProxy.m_ptr->m_bAdvance = 1;
    if ( v5->m_GFXMovie.m_movieProxy.m_ptr )
      v5->m_GFXMovie.m_movieProxy.m_ptr->m_bRender = 1;
  }
  if ( !v5 )
  {
    soundName.m_sharedBuffer.m_ptr = (extension::exsound_detail::SoundNameRegistry::NameBuffer *)operator new(0x108ui64);
  ...
  GfxManager::LoadRequest(v5, FILE_13_TRIALMENU, 0i64, a4);
  SyncMenuImage::Load(
    &this->m_SyncMenuBG,
    (const ImageDataInfo *)MenuImageDataTbl[*(int *)(*(_QWORD *)&AppMain::pApp + 2197384i64)] + 26,
    FADE_IN);
  v8 = (volatile signed __int64 *)s_soundIndex.m_keys[114].m_sharedBuffer.m_ptr;
  soundName.m_sharedBuffer.m_ptr = s_soundIndex.m_keys[114].m_sharedBuffer.m_ptr;
  if ( s_soundIndex.m_keys[114].m_sharedBuffer.m_ptr )
  {
    v8 = (volatile signed __int64 *)s_soundIndex.m_keys[114].m_sharedBuffer.m_ptr->m_refCount.m_ptr;
    _InterlockedExchangeAdd64(v8 + 2, 1ui64);
  }
  p_soundName = &soundName;
  AppMain::Sound_BGMPlay_GetSoundHashKey((AppMain *)v8, &result);
...
LABEL_26:
  ...
  this->m_FuncST = 58;
  this->m_FuncBT = 59;
  AppMain::SceneFunc(this, 58);
  this->m_FuncExit = 57;
}

void __fastcall AppMain::ST_MissionTrialLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
  ...
  if ( v2->m_bQuitGFXMovie )
  {
    ...
    {
      GameDataInfo::getInstance()->m_MissionTrialNo = m_QuitResultCode;
      Instance = GameDataInfo::getInstance();
      Instance->m_StageID = STAGE_ID_TRA;
      Instance->m_StageRandom = 0;
      ...
      GfxManager::LoadRequestMissionTrial(v8);
      ...
      extension::SoundManager::stopBGM(v9, 1.0);
      ...
      v11->m_ReleaseFlag = 1;
      AppMain::SetBattleSetting(this, v10);
      this->m_iLoadingNextFunc = 177;
      this->m_FadeST = 183;
      this->m_bExitFuncWaitFrame = 0;
    }
    v12 = this->m_FuncFT == 170;
    this->m_FadeExitFunc = 57;
    this->m_FuncST = 0;
    this->iReserveScene = -1;
    if ( !v12 )
      this->m_FuncFT = 172;
