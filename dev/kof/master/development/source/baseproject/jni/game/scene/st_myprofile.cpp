...
bool s_FlagGotOnlineProfile; // 0x140A97492
bool s_FlagOnline; // 0x140A97493
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5E0D0
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B18
void AppMain::ST_MyProfileInit(); // 0x1401CBC90
void AppMain::ST_MyProfileLoop(); // 0x1401CBDE0
void AppMain::ST_MyProfileDraw(); // 0x1401C06B0//decompilation failure at 140A97492!
//decompilation failure at 140A97493!
//decompilation failure at 140A5E0D0!
//decompilation failure at 1408A0B18!
...
void __fastcall AppMain::ST_MyProfileInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  UserGameOperation *v6; // rax
  int v7; // ecx
  GfxManager *v8; // [rsp+40h] [rbp+8h]
  clasChkDisconOnlineSv *v9; // [rsp+40h] [rbp+8h]
  ...
  GfxManager::LoadRequest(v5, FILE_17_MY_PROFILE, 0i64, a4);
  ...
  if ( Fw::NetworkStatusCommon::m_OnlineFlag )
  {
    ...
    {
      v9 = (clasChkDisconOnlineSv *)operator new(2ui64);
      *v9 = 0;
      clasChkDisconOnlineSv::_instance = v9;
    }
  ...
  s_FlagGotOnlineProfile = 0;
  this->iReserveScene = -1;
  this->m_FuncST = 78;
  this->m_FuncBT = 79;
  AppMain::SceneFunc(this, 78);
  this->m_FuncExit = 77;
}

void __fastcall AppMain::ST_MyProfileLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  clasChkDisconOnlineSv *v4; // rax
  int v5; // eax
  clasChkDisconOnlineSv *v6; // rax
  GfxManager *v7; // rax
  ...
  {
    v4 = clasChkDisconOnlineSv::_instance;
    if ( !clasChkDisconOnlineSv::_instance )
    {
      v4 = (clasChkDisconOnlineSv *)operator new((unsigned int)((_DWORD)clasChkDisconOnlineSv::_instance + 2));
      *v4 = 0;
      clasChkDisconOnlineSv::_instance = v4;
    }
    v5 = clasChkDisconOnlineSv::check(v4) - 2;
    if ( v5 )
    {
      if ( v5 != 1 )
        goto LABEL_13;
      v6 = clasChkDisconOnlineSv::_instance;
      if ( !clasChkDisconOnlineSv::_instance )
      {
        v6 = (clasChkDisconOnlineSv *)operator new((unsigned int)((_DWORD)clasChkDisconOnlineSv::_instance + 2));
        *v6 = 0;
        clasChkDisconOnlineSv::_instance = v6;
      }
      v6->m_RankmatchGameStart = 1;
    }
    s_FlagGotOnlineProfile = 1;
  }
LABEL_13:
  ...
  if ( v7->m_SystemMessageState != SYSTEM_MESSAGE_OPEN || !v7->m_SystemMessageLock )
  {
    v8 = extension::GFXIMovieStack::Instance();
    extension::GFXIMovieStack::advance(v8, 0.016666668);
    v7 = GfxManager::instance;
  }
