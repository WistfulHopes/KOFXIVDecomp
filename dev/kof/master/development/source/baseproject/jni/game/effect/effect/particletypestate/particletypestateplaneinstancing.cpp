...
std::piecewise_construct_t std::piecewise_construct; // 0x14089E397
void ParticleTypeStatePlaneInstancing::InitVertexBuffer(std::vector<ParticleData,std::allocator<ParticleData> > * ParticleData, EffectData * pEmitterData); // 0x14002E7C0
void ParticleTypeStatePlaneInstancing::loadFigure(const char * filename); // 0x14014EFF0
void ParticleTypeStatePlaneInstancing::UpdateVertexBuffer(EffectUpdateBufferArgument * pUpdateBufferArg); // 0x14014F030
void ParticleTypeStatePlaneInstancing::Render(EffectRenderArgument * pRenderArg); // 0x14014F040//decompilation failure at 14089E397!
void __fastcall ActorWeapon::ActionFlagCheck(_SETJMP_FLOAT128 *JumpBuffer)
{
  ;
}

void __fastcall ParticleTypeStatePlaneInstancing::Render(
        ParticleTypeStatePlaneInstancing *this,
        EffectRenderArgument *pRenderArg)
{
  ...
  v5 = *(OGLRender **)(*(_QWORD *)&AppMain::pApp + 80i64);
  if ( ((unsigned __int8 (__fastcall *)(ParticleTypeStatePlaneInstancing *, EffectData *, _QWORD))this->RenderErrorCheck)(
         this,
         pRenderArg->pEffectData,
         (unsigned int)pRenderArg->renderOpt)
    && this->RenderSetting(this, pRenderArg->pEffectData, &pRenderArg->renderOpt, &pRenderArg->priority) )
  {
    ...
    if ( (unsigned __int64)(Myfirst[2].allEditNumData._Mypair._Myval2._Mylast
      ...
      std::_Xout_of_range("invalid vector<T> subscript");
    v8 = *(int *)(*(_QWORD *)(v2 + 2507504) + 2256i64);
    if ( pRenderArg->pParticleDataVec->_Mypair._Myval2._Mylast - pRenderArg->pParticleDataVec->_Mypair._Myval2._Myfirst )
    {
      this->SetRenderData(this, pEffectData, &pRenderArg->renderOpt, &pRenderArg->zOffset, &pRenderArg->priority);
      OGLRender::drawEffectIndexInstancesUVAnime(
        v5,
        &this->m_pParticleEmitter->m_BlendProjData,
        &this->m_TextureData,
        &this->m_EffectMeshData[v8],
        &this->m_EffectConstData);
    }
  }
}

void __fastcall ParticleTypeStatePlaneInstancing::UpdateVertexBuffer(
        ParticleTypeStatePlaneInstancing *this,
        EffectUpdateBufferArgument *pUpdateBufferArg)
{
  this->UpdateVertexBufferInstancing(this, pUpdateBufferArg);
}

void __fastcall ParticleTypeStatePlaneInstancing::loadFigure(
        ParticleTypeStatePlaneInstancing *this,
        const char *filename)
{
  CharaProjectData::GetCharaDataIndex(*(CharaProjectData **)(*(_QWORD *)&AppMain::pApp + 10888i64), 999);
  this->loadFigureToGPUMem(this, "Chara/CMN/Effect/CMN_DefaultPlane.obac");
}
