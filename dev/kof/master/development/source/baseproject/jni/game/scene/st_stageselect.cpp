...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5F510
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B2D
void LoadCompleteEventStageSelect(); // 0x140204F30
void AppMain::ST_StageSelectInit(); // 0x140205150
void AppMain::ST_StageSelectLoop(); // 0x1402053B0
void AppMain::ST_StageSelectDraw(); // 0x1401C06B0//decompilation failure at 140A5F510!
//decompilation failure at 1408A0B2D!
void __fastcall LoadCompleteEventStageSelect()
{
  GfxManager *v0; // rbx
  GfxManager *v1; // rax
  _DWORD *v2; // rsi
  ...
  if ( `GameDataInfo::getInstance'::`2'::instance.m_ControllerSetting[1] )
  {
LABEL_35:
  ...
  p_userIndex = &v7->m_slots[0].userIndex;
  if ( v7 != (FighterOperation *)-8i64 )
  {
    v9 = *p_userIndex;
    *p_userIndex = v6;
    v7->m_slots[0].userId = v6;
    if ( v9 != v6 )
    {
    ...
    if ( v17 != v14 )
    {
      ...
      if ( v19 != &v15->m_assignListenerListEnd )
      {
        do
        {
          ...
          if ( !v19 )
            v20 = 0i64;
          ((void (__fastcall *)(extension::BiLinkable<FighterOperation::ListenerNode> **, __int64, _QWORD))(*v20)->m_Next)(
            v20,
            2i64,
            (unsigned int)v14);
          v19 = v19->m_Next;
...
void __fastcall AppMain::ST_StageSelectInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GameDataInfo *v5; // rcx
  GfxManager *v6; // rax
  UserGameOperation *v7; // rax
  extension::RefCountableWeakSupportBase::WeakProxy *v8; // rcx
  char *m_str; // rsi
  ...
  GfxManager::LoadRequest(v6, FILE_05_STAGESELECT, LoadCompleteEventStageSelect, a4);
  ...
  this->m_bFadeLock = 0;
  m_ptr = this->m_nowPlayBGM.m_sharedBuffer.m_ptr;
  soundName.m_sharedBuffer.m_ptr = m_ptr;
  if ( m_ptr )
  {
    v8 = m_ptr->m_refCount.m_ptr;
    _InterlockedExchangeAdd64((volatile signed __int64 *)&v8->m_sharedCount, 1ui64);
  }
  ...
  v13 = result.m_sharedBuffer.m_ptr->m_str;
  v14 = m_str - result.m_sharedBuffer.m_ptr->m_str;
  do
  {
...
LABEL_15:
  ...
  if ( (this->SaveDataMain.GameData.m_FirstNoticeFlag.m_Flag[0] & 0x10000) != 0 )
  {
    this->SaveDataMain.GameData.m_FirstNoticeFlag.m_Flag[0] &= ~0x10000u;
    ...
    GfxManager::GFv_AddNotification(v17, "$STAGE_USE_INFO_DA", ICON_NO_VRS);
  }
  this->iReserveScene = -1;
  this->m_FuncST = 34;
  this->m_FuncBT = 35;
  AppMain::SceneFunc(this, 34);
  this->m_FuncExit = 33;
}

void __fastcall AppMain::ST_StageSelectLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  __int64 *v4; // rcx
  ...
  STAGE_ID stageID; // edx
  __int64 v24; // rax
  bool v25; // dl
  int v26; // edx
  GfxManager *v27; // [rsp+40h] [rbp+8h]
  GfxManager *v28; // [rsp+40h] [rbp+8h]
  GfxManager *v29; // [rsp+40h] [rbp+8h]
  GfxManager *v30; // [rsp+40h] [rbp+8h]
...
LABEL_13:
  ...
  v9 = AppMain::InputCheckNewChallengerTraining(this) == 0;
  ...
  if ( v10->m_SystemMessageState != SYSTEM_MESSAGE_OPEN || !v10->m_SystemMessageLock )
  {
    v13 = extension::GFXIMovieStack::Instance();
    extension::GFXIMovieStack::advance(v13, 0.016666668);
  }
  if ( v2->m_bQuitGFXMovie )
  {
    ...
    if ( v15 == 1 )
    {
      AppMain::setNonFadeSTExit(this, 16, 33);
    }
    else
    {
      ...
      if ( *(_BYTE *)(v17 + 257) )
      {
        ...
        {
          GfxManager::getInstance();
          this->SaveDataMain.PlayerData.m_MyFavoriteStage[*(int *)(v18 + 224)] = m_StageID;
        }
        v19 = GameDataInfo::getInstance();
        v20 = v19->m_GameModeIndex - 1;
        if ( v20 <= 0 )
          v20 = 0;
        v19->m_GameModeIndex = v20;
        GfxManager::getInstance();
        *(_BYTE *)(v21 + 257) = 0;
        if ( (this->SaveDataMain.GameData.m_FirstNoticeFlag.m_Flag[0] & 0x40000) != 0 )
          AppMain::setNonFadeSTExit(this, 80, 33);
        else
          AppMain::setNonFadeSTExit(this, 100, 33);
      }
      else
      {
        if ( g_NetworkManager.gamedata.onlinePlay )
        {
          ...
          if ( v22->m_GameMode[v22->m_GameModeIndex] == GAME_MODE_TRAINING )
            stageID = m_StageID;
          g_NetworkManager.rank_traning_wait.stageID = stageID;
        }
        GfxManager::getInstance();
        *(_BYTE *)(v24 + 172) = 1;
        AppMain::SetBattleSetting(this, v25);
        AppMain::SetBattleLoadingNonFade(this, v26, 33);
      }
    }
  }
}
