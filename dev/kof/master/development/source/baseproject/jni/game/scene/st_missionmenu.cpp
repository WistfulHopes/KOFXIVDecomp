...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5DD70
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B13
void AppMain::ST_MissionMenuInit(); // 0x1401CA8C0
void AppMain::ST_MissionMenuLoop(); // 0x1401CAB00
void AppMain::ST_MissionMenuDraw(); // 0x1401C06B0//decompilation failure at 140A5DD70!
//decompilation failure at 1408A0B13!
...
void __fastcall AppMain::ST_MissionMenuInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_01_UI_MENU_MISSION, 0i64, a4);
  ...
  if ( m_ptr )
  {
    v8 = (__int64)m_ptr->m_refCount.m_ptr;
    _InterlockedExchangeAdd64((volatile signed __int64 *)(v8 + 16), 1ui64);
  }
...
LABEL_15:
  ...
  this->m_FuncST = 54;
  this->m_FuncBT = 55;
  AppMain::SceneFunc(this, 54);
  this->m_FuncExit = 53;
}

void __fastcall AppMain::ST_MissionMenuLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
  ...
  if ( v2->m_bQuitGFXMovie )
  {
    ...
    v6 = v4->m_MenuCursor[3];
    if ( v4->m_QuitResultCode == RESULT_CODE_CANCEL )
    {
      this->iReserveScene = -1;
      this->m_FadeST = 16;
      this->m_FuncST = 0;
      this->m_FadeExitFunc = 53;
    ...
    else
    {
      if ( v6 )
      {
        ...
        if ( v7 )
        {
          ...
          Instance->m_GameMode[Instance->m_GameModeIndex] = GAME_MODE_MISSION_SURVIVAL;
        }
        else
        {
          v11 = GameDataInfo::getInstance();
          v11->m_GameMode[v11->m_GameModeIndex] = GAME_MODE_MISSION_TIMEATTACK;
        }
        v9 = GameDataInfo::getInstance();
        v9->m_GameRule[v9->m_GameRuleIndex] = GAME_RULE_SINGLE;
        ...
        GameDataInfo::SetDefaultSettingSaveData(v10);
        GameDataInfo::getInstance()->m_SurvivalWinCount = -2068357983;
      }
      else
      {
        v12 = GameDataInfo::getInstance();
        v12->m_GameMode[v12->m_GameModeIndex] = GAME_MODE_MISSION_TRIAL;
        v13 = GameDataInfo::getInstance();
        v13->m_GameRule[v13->m_GameRuleIndex] = GAME_RULE_SINGLE;
        GameDataInfo::getInstance()->m_ControllerSetting[0] = USER_ID_1P;
        GameDataInfo::getInstance()->m_ControllerSetting[1] = USER_ID_CPU;
      ...
      *(_BYTE *)(v16 + 257) = 0;
      AppMain::setNonFadeSTExit(this, 24, 53);
    }
  }
}
