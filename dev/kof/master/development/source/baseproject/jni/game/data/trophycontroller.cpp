...
std::piecewise_construct_t std::piecewise_construct; // 0x14089B4EC
PLAYER_ID getTrophyPlayerID(); // 0x14011C300
bool IsEnableGameMode4TorophyCntup(); // 0x14011C4B0//decompilation failure at 14089B4EC!
bool __fastcall IsEnableGameMode4TorophyCntup()
{
  char v0; // bl
  _DWORD *v1; // rdi
  __int64 v2; // rcx
  ...
  __int64 v7; // rax
  BattleSystem::BattleController *v9; // [rsp+40h] [rbp+8h]
  BattleSystem::BattleController *v10; // [rsp+40h] [rbp+8h]

  v0 = 0;
  v1 = (_DWORD *)(*(_QWORD *)NtCurrentTeb()->Reserved1[11] + 40i64);
  v2 = (unsigned int)__TSS0__1__getInstance_GameDataInfo__SAAEAV2_XZ_4HA;
  ...
  if ( (unsigned int)(v3 - 4) <= 2 || v3 == GAME_MODE_ONLINETRAINING )
    v0 = 1;
  if ( (int)v2 > *v1 )
  {
    Init_thread_header((int *)&__TSS0__1__getInstance_GameDataInfo__SAAEAV2_XZ_4HA);
  ...
  if ( v0 )
  {
    v2 = 118i64 * (unsigned __int8)g_NetworkManager.gamedata.myNo;
    if ( (*(_DWORD *)((char *)g_NetworkManager.gamedata.player_data + v2 + 16) & 0xC0000) != 0 )
      return 0;
  }
  ...
  if ( BattleSystem::BattleController::IsTutorialMode((BattleSystem::BattleController *)v2) )
    return 0;
  ...
  if ( battleMode == MISSION )
    return 0;
  if ( battleMode == MISSION_DEVELOP )
    return 0;
  BattleSystem::BattleController::GetActionSystem();
  return *(_DWORD *)(v7 + 246072) != 3;
}

__int64 __fastcall getTrophyPlayerID()
{
  _DWORD *v0; // rbx
  int v1; // eax
  GAME_MODE v3; // ecx
  FighterOperation::Slot *m_slots; // rax
  FighterOperation::Slot *v5; // rax
  __int64 PlayerID; // rbx
  NetManager *v7; // rcx
  int PlayerIndex; // esi
  __int64 v9; // rax
  __int64 v10; // rdi
  ...
  v0 = (_DWORD *)(*(_QWORD *)NtCurrentTeb()->Reserved1[11] + 40i64);
  v1 = (int)__TSS0__1__getInstance_GameDataInfo__SAAEAV2_XZ_4HA;
  if ( (int)__TSS0__1__getInstance_GameDataInfo__SAAEAV2_XZ_4HA > *v0 )
  {
    Init_thread_header((int *)&__TSS0__1__getInstance_GameDataInfo__SAAEAV2_XZ_4HA);
    v1 = (int)__TSS0__1__getInstance_GameDataInfo__SAAEAV2_XZ_4HA;
    if ( (_DWORD)__TSS0__1__getInstance_GameDataInfo__SAAEAV2_XZ_4HA == -1 )
  ...
  if ( (unsigned int)(v3 - 4) > 2 && v3 != GAME_MODE_ONLINETRAINING )
  {
    m_slots = FighterOperation::Instance()->m_slots;
    if ( m_slots && m_slots->userId == 1 )
      return 0i64;
    v5 = &FighterOperation::Instance()->m_slots[1];
    if ( v5 && v5->userId == 1 )
      return 1i64;
    return 0xFFFFFFFFi64;
  }
  ...
  PlayerIndex = NetManager::GetPlayerIndex(v7, -1);
  if ( (_DWORD)PlayerID == -1 )
    return 0xFFFFFFFFi64;
  BattleSystem::BattleController::GetActionSystem();
  v10 = v9;
  Instance = GameDataInfo::getInstance();
  if ( Instance->m_GameRule[Instance->m_GameRuleIndex] != GAME_RULE_PARTY
    || *(_DWORD *)(168 * (PlayerID + 1466) + v10) == PlayerIndex )
  {
    return (unsigned int)PlayerID;
  }
  else
  {
    return 0xFFFFFFFFi64;
