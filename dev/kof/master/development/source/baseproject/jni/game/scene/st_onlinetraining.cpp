...
enum <unnamed-enum-SCENE_ONLINE_TRAINING_LOOP>
{
	SCENE_ONLINE_TRAINING_LOOP = 0,
	SCENE_ONLINE_TRAINING_SEARCHING = 1,
	SCENE_ONLINE_TRAINING_CREATEROOM = 2,
	SCENE_ONLINE_TRAINING_END = 3,
};
...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5E550
long s_SceneSequence; // 0x140AC4B8C
unsigned char s_FilterSequence; // 0x140AA37BA
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B1C
char s_FilterStr[49]; // 0x140AC4C48
void LoadCompleteEventOnlineTraining(); // 0x1401C17F0
void AppMain::ST_OnlineTrainingInit(); // 0x1401CD500
void AppMain::ST_OnlineTrainingLoop(); // 0x1401CD940
void AppMain::ST_OnlineTrainingDraw(); // 0x1401C06B0//decompilation failure at 140A5E550!
//decompilation failure at 140AC4B8C!
//decompilation failure at 140AA37BA!
//decompilation failure at 1408A0B1C!
//decompilation failure at 140AC4C48!
...
void __fastcall AppMain::ST_OnlineTrainingInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  v17 = soundName.m_sharedBuffer.m_ptr ? soundName.m_sharedBuffer.m_ptr->m_str : 0i64;
  m_str = result.m_sharedBuffer.m_ptr->m_str;
  v19 = v17 - result.m_sharedBuffer.m_ptr->m_str;
  do
  {
    v20 = (unsigned __int8)m_str[v19];
    v21 = (unsigned __int8)*m_str - v20;
    if ( v21 )
      break;
    ++m_str;
  }
...
LABEL_30:
  ...
  this->MatchingGameRule = GAME_RULE_TRAINING;
  ...
  `GameDataInfo::getInstance'::`2'::instance.m_GameMode[`GameDataInfo::getInstance'::`2'::instance.m_GameModeIndex] = GAME_MODE_ONLINETRAINING;
  ...
  this->m_FuncST = 158;
  this->m_FuncBT = 159;
  AppMain::SceneFunc(this, 158);
  this->m_FuncExit = 157;
}

void __fastcall AppMain::ST_OnlineTrainingLoop(AppMain *this)
{
  GfxManager *v2; // rax
  GfxManager *v3; // r15
  ...
  __int64 v30; // rax
  __int64 v31; // rax
  extension::gfxi_detail::MovieProxy *v32; // [rsp+48h] [rbp-C0h]
  extension::gfxi_detail::MovieProxy *v33; // [rsp+48h] [rbp-C0h]
  extension::gfxi_detail::MovieProxy *v34; // [rsp+48h] [rbp-C0h]
  GfxManager *v35; // [rsp+50h] [rbp-B8h]
  GfxManager *v36; // [rsp+50h] [rbp-B8h]
  Scaleform::GFx::Value ptr; // [rsp+58h] [rbp-B0h] BYREF
  Scaleform::GFx::Value val; // [rsp+88h] [rbp-80h] BYREF
  __int64 v39; // [rsp+B8h] [rbp-50h]
  char source[128]; // [rsp+C8h] [rbp-40h] BYREF
  unsigned __int64 v41; // [rsp+1C8h] [rbp+C0h]
  char destination[256]; // [rsp+1D8h] [rbp+D0h] BYREF
  unsigned __int64 m_textLength; // [rsp+2D8h] [rbp+1D0h]

  v39 = -2i64;
  v2 = GfxManager::instance;
  if ( !GfxManager::instance )
  {
    v32 = (extension::gfxi_detail::MovieProxy *)operator new(0x108ui64);
    GfxManager::GfxManager((GfxManager *)v32);
    GfxManager::instance = v2;
  }
  v3 = v2;
  if ( !v2 )
  {
    v33 = (extension::gfxi_detail::MovieProxy *)operator new(0x108ui64);
    GfxManager::GfxManager((GfxManager *)v33);
    GfxManager::instance = v2;
  }
  m_ptr = v2->m_GFXMovie.m_movieProxy.m_ptr;
  v34 = v2->m_GFXMovie.m_movieProxy.m_ptr;
  ...
  if ( v8 == 1 )
  {
    ...
    AppMain::UpdateRoomNameText(v12, destination);
    v10 = Fw::ImeTarget::m_currentIME;
    v9 = Fw::ImeTarget::m_IMEKeyboard.m_Status;
    m_Status = (unsigned int)Fw::ImeTarget::m_IMEPad.m_Status;
  }
LABEL_31:
  if ( s_SceneSequence_0 == 3 )
  {
  ...
  if ( s_FilterSequence_1 != 1 )
  {
    ...
    if ( v10 )
    {
      if ( (_DWORD)m_Status == 2 )
      {
        ...
        v41 = Fw::ImeTarget::m_IMEPad.m_textLength;
        Fw::ImeTarget::m_IMEPad.m_Status = 0;
      }
      else
      {
    ...
    if ( v23 )
    {
      ...
      {
        strcpy_s(s_FilterStr_1, 0x31ui64, source);
        s_FilterSequence_1 = 1;
        goto LABEL_63;
      }
    }
    s_FilterSequence_1 = 0;
...
LABEL_62:
  ...
  {
    s_FilterSequence_1 = 0;
    strcpy_s(this->SaveDataMain.PlayerData.m_MyRoomName, 0x31ui64, s_FilterStr_1);
    goto LABEL_62;
  }
  s_FilterSequence_1 = 0;
LABEL_63:
  ...
  if ( s_SceneSequence_0 != 1 )
  {
    if ( s_SceneSequence_0 == 2 && g_NetworkManager.gamedata.onlineState == NET_STATE_WAITCLIENT )
    {
      ...
      s_SceneSequence_0 = 3;
      v26 = *(unsigned int *)(*(_QWORD *)&AppMain::pApp + 2205204i64) + 1i64;
      if ( v26 < 0 )
      {
        *(_DWORD *)(*(_QWORD *)&AppMain::pApp + 2205204i64) = 0;
      }
      else if ( v26 >= 0xFFFFFFFFi64 )
      {
        *(_DWORD *)(*(_QWORD *)&AppMain::pApp + 2205204i64) = -1;
      }
      else
      {
        *(_DWORD *)(*(_QWORD *)&AppMain::pApp + 2205204i64) = v26;
      }
...
LABEL_100:
    ...
    || !Fw::MatchingTarget::m_SearchRoomNum )
  {
    ...
    {
      GfxManager::getInstance();
      GfxManager::GFv_SetSystemMessage(v27, "$POPUP_NOTFOUND", SYSTEM_MESSAGE_OK, 0, 1, "no_title", &pnewText, "size_s");
      s_SceneSequence_0 = 0;
      g_NetworkManager.gamedata.m_SearchRoomLimit = 0;
    }
    goto LABEL_100;
  ...
  val.Type = VT_Float;
  val.mValue.IValue = 10;
  if ( m_ptr && Scaleform::GFx::Movie::IsAvailable(m_ptr->m_movie.pObject, "_root.StartEnd") )
    Scaleform::GFx::Movie::Invoke(m_ptr->m_movie.pObject, "_root.StartEnd", 0i64, &val, 1u);
  s_SceneSequence_0 = 3;
...
LABEL_109:
  if ( m_ptr )
  {
    ...
    {
      extension::gfxi_detail::MovieProxy::~MovieProxy(v34);
      operator delete(v34, 0xE8ui64);
    }
  }
}
