...
const char * ImageFilePath_YouWin; // 0x14088C4F0
const _C_CONV ImageRects_YouWin[68]; // 0x14088C500
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_DEF = 0x0;
std::piecewise_construct_t std::piecewise_construct; // 0x14088C431
void BattleCallAnimationYouWin::readResources_EN(); // 0x1400B6320//decompilation failure at 14088C4F0!
//decompilation failure at 14088C500!
//decompilation failure at 14088C431!
void __fastcall BattleCallAnimationYouWin::readResources_EN(BattleCallAnimationYouWin *this)
{
  __int64 v2; // rax
  bool v3; // cf
  ...
  if ( p_m_refCount )
  {
    ...
    std::string::assign(&_Right, "ui/battle_ui/_EN/announce/You_Win_out.obm", aUiBattleUiEnAn_9[0] != 0 ? 0x29 : 0);
