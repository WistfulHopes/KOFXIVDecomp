...
const char * ImageFilePath_DoubleKO; // 0x14088B5E0
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_DEF = 0x0;
const `anonymous-namespace'::<unnamed-enum-DKO_EFF_FLARE_KO> `anonymous namespace'::DKO_KO = 0x3F;
const `anonymous-namespace'::<unnamed-enum-DKO_EFF_FLARE_KO> `anonymous namespace'::DKO_EFF_KO_BURST = 0x40;
const _C_CONV ImageRects_DoubleKO[264]; // 0x14088B5F0
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_MAX = 0x1;
std::piecewise_construct_t std::piecewise_construct; // 0x14088B591
void BattleCallAnimationDoubleKO::readResources_EN(); // 0x1400AC010
void BattleCallAnimationDoubleKO::drawAnimations_EN(float frame); // 0x1400AC230//decompilation failure at 14088B5E0!
//decompilation failure at 14088B5F0!
//decompilation failure at 14088B591!
void __fastcall BattleCallAnimationDoubleKO::drawAnimations_EN(BattleCallAnimationDoubleKO *this, float frame)
{
...
LABEL_30:
          *(float *)&type5 = v12;
          ...
          drawConvAA(Myval2, 960.0, 540.0, &ImageRects_DoubleKO_0[63], v8, v7);
          if ( frame >= 0.0 )
          {
            easing(
              (float *)&type5,
          ...
          drawConvAA(Myval2, 960.0, 540.0, &ImageRects_DoubleKO_0[64], v8, v7);
          v15 = (Image *)extension::BasicFutureObject<extension::GFXIMovieData,void>::operator->(
                           ...
                           v14);
          BattleCallAnimationCommons::drawEffect_KO_EN(v16, frame, v15, ImageRects_DoubleKO_0);
          return;
        }
      }
    }
...
void __fastcall BattleCallAnimationDoubleKO::readResources_EN(BattleCallAnimationDoubleKO *this)
{
  __int64 v2; // rax
  bool v3; // cf
  ...
  if ( p_m_refCount )
  {
    ...
    std::string::assign(&_Right, "ui/battle_ui/_EN/announce/DoubleKO_out.obm", aUiBattleUiEnAn_13[0] != 0 ? 0x2A : 0);
