...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5E670
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B1D
void AppMain::ST_OptionInit(); // 0x1401CE0F0
void AppMain::ST_OptionLoop(); // 0x1401CE260
void AppMain::ST_OptionDraw(); // 0x1401CE380//decompilation failure at 140A5E670!
//decompilation failure at 1408A0B1D!
void __fastcall AppMain::ST_OptionDraw(AppMain *this)
{
  Graphics *v2; // rcx
  int m_SceneTime; // eax
  Graphics *g; // rcx
  ...
  m_SceneTime = this->m_SceneTime;
  if ( m_SceneTime <= 0 || this->m_RequestCupture )
  {
    Graphics::setRenderMode(this->g->g, 3, 255);
    SyncMenuImage::Draw(&this->m_SyncMenuBG, this->g, v5, v6, 1.0);
    ...
    extension::GFXIMovieStack::render(v8);
  }
  else
  {
    this->m_SceneTime = m_SceneTime - 1;
    g = this->g->g;
    g->m_Operator = 0;
    g->m_SrcRatio = 255;
    g->m_DstRatio = 255;
...
void __fastcall AppMain::ST_OptionInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  extension::SoundManager *v16; // [rsp+40h] [rbp+8h]
  ...
  GfxManager::LoadRequest(v5, FILE_18_OPTION, 0i64, a4);
  ...
  {
    v16 = (extension::SoundManager *)operator new(0x310ui64);
    extension::SoundManager::SoundManager(v16);
    extension::SoundManager::the_instance = v7;
  }
  v7->m_globalPadOutputMaskUsers = 15;
  this->m_SceneState = this->SaveDataMain.SysOptionData.iUILanguage;
  this->m_SceneTime = 0;
    ...
    if ( userIndex != 1 )
    {
      ...
      if ( m_Next != &v8->m_assignListenerListEnd )
      {
        do
        {
          ...
          if ( !m_Next )
            p_m_Next = 0i64;
          ((void (__fastcall *)(extension::BiLinkable<FighterOperation::ListenerNode> **, __int64, __int64, __int64, __int64))(*p_m_Next)->m_Next)(
            p_m_Next,
            1i64,
            1i64,
            0xFFFFFFFFi64,
  ...
  this->m_FuncST = 46;
  this->m_FuncBT = 47;
  AppMain::SceneFunc(this, 46);
  this->m_FuncExit = 45;
}

void __fastcall AppMain::ST_OptionLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
  ...
  if ( this->m_SceneState != iUILanguage )
  {
    this->m_RequestCupture = 1;
    this->m_SceneState = iUILanguage;
    this->m_SceneTime = 5;
  }
