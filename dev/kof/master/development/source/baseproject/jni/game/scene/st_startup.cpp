...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5ED30
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B25
void LoadCompleteStartUp(); // 0x1401FA9C0
void AppMain::ST_StartUpInit(); // 0x1401FAA00
void AppMain::ST_StartUpLoop(); // 0x1401FABB0
void AppMain::ST_StartUpDraw(); // 0x1401FACA0//decompilation failure at 140A5ED30!
//decompilation failure at 1408A0B25!
void __fastcall LoadCompleteStartUp()
{
  AppMain::ResizeDisplay(
    *(AppMain **)&AppMain::pApp,
    *(_DWORD *)(*(_QWORD *)&AppMain::pApp + 4i64 * *(int *)(*(_QWORD *)&AppMain::pApp + 2197464i64) + 2197440),
    *(_DWORD *)(*(_QWORD *)&AppMain::pApp + 4i64 * *(int *)(*(_QWORD *)&AppMain::pApp + 2197464i64) + 2197452),
    *(AgWindowMode *)(*(_QWORD *)&AppMain::pApp + 2197464i64),
    1);
}

void __fastcall AppMain::ST_StartUpDraw(AppMain *this)
{
  Graphics *v2; // rcx
  Graphics *g; // rdx
  GfxManager *v4; // rax
...
void __fastcall AppMain::ST_StartUpInit(AppMain *this)
{
  extension::GFXIFontManager *v2; // rax
  int v3; // er9
  extension::GFXIFontManager *v4; // rdi
  ...
  v2 = extension::GFXIFontManager::Instance();
  v4 = v2;
  if ( !v2->m_pendingFontStates.m_fontLib.pObject )
  {
    Myfirst = v2->m_pendingFontStates.m_fontFiles._Mypair._Myval2._Myfirst;
    Mylast = v2->m_pendingFontStates.m_fontFiles._Mypair._Myval2._Mylast;
    if ( Myfirst != Mylast )
    {
      do
      {
        ...
        if ( m_ptr )
        {
          ...
          {
            p_m_status = &m_ptr->m_status;
            if ( (p_m_status->m_stateFlags.m_value._My_val & 1) == 0 )
              extension::AsyncStatus::waitFor(p_m_status, (extension::AsyncStatus::Step)Mylast);
          }
        }
        ++Myfirst;
      }
      while ( Myfirst != v4->m_pendingFontStates.m_fontFiles._Mypair._Myval2._Mylast );
    }
  }
  ...
  GfxManager::LoadRequest(v9, FILE_00_START_UP, LoadCompleteStartUp, v3);
  v10 = UserGameOperation::Instance();
  UserGameOperation::clear(v10);
  ...
  GfxManager::LoadRequestNotification(v12);
  ...
  GfxManager::LoadRequestSystem(v13);
  SyncMenuImage::Release(&this->m_SyncMenuBG);
  this->iReserveScene = -1;
  this->m_FuncST = 6;
  this->m_FuncBT = 7;
  AppMain::SceneFunc(this, 6);
  this->m_FuncExit = 5;
}

void __fastcall AppMain::ST_StartUpLoop(AppMain *this)
{
  GfxManager *v2; // rax
  GfxManager *v3; // rdi
  extension::GFXIMovieStack *v4; // rax
  GfxManager *v5; // [rsp+48h] [rbp+10h]
