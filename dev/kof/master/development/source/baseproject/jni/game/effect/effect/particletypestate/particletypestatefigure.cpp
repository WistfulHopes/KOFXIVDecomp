...
std::piecewise_construct_t std::piecewise_construct; // 0x14089E393
void ParticleTypeStateFigure::calcWorldMat(ParticleData * pParticleData, EffectData * pEffectData); // 0x14014D850
void ParticleTypeStateFigure::calcWorldMatInBT(ParticleData * pParticleData, EffectData * pEffectData); // 0x14002E7C0//decompilation failure at 14089E393!
void __fastcall ParticleTypeStateFigure::calcWorldMat(
        ParticleTypeStateFigure *this,
        ...
        EffectData *pEffectData)
{
  ...
  *(_QWORD *)&pParticleData->WorldMat.m[14] = 0i64;
  ...
  if ( (unsigned __int64)(v24[2].allComboIndexData._Mypair._Myval2._Mylast
                        - v24[2].allComboIndexData._Mypair._Myval2._Myfirst) <= 4 )
    std::_Xout_of_range("invalid vector<T> subscript");
  if ( v24[2].allComboIndexData._Mypair._Myval2._Myfirst[4] == 2 )
  {
  ...
  if ( (unsigned __int64)(v25[2].allComboIndexData._Mypair._Myval2._Mylast
                        - v25[2].allComboIndexData._Mypair._Myval2._Myfirst) <= 4 )
    std::_Xout_of_range("invalid vector<T> subscript");
  if ( v25[2].allComboIndexData._Mypair._Myval2._Myfirst[4] == 1 )
  ...
  v27 = In.m[13] + v26->y;
  v28 = In.m[14] + v26->z;
  pParticleData->WorldMat.m[12] = (float)(In.m[12] + v26->x) + pParticleData->WorldMat.m[12];
