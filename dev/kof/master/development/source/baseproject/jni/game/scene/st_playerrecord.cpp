...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5E9D0
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B20
void AppMain::ST_PlayerRecordInit(); // 0x1401D0000
void AppMain::ST_PlayerRecordLoop(); // 0x1401D00F0
void AppMain::ST_PlayerRecordDraw(); // 0x1401C06B0//decompilation failure at 140A5E9D0!
//decompilation failure at 1408A0B20!
...
void __fastcall AppMain::ST_PlayerRecordInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_17_PLAYER_RECORD, 0i64, a4);
  ...
  this->m_FuncST = 66;
  this->m_FuncBT = 67;
  AppMain::SceneFunc(this, 66);
  this->m_FuncExit = 65;
}

void __fastcall AppMain::ST_PlayerRecordLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
