...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5F870
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B30
void LoadCompleteEventTitle(); // 0x1401C7760
void AppMain::ST_TitleInit(); // 0x140207B40
void AppMain::ST_TitleLoop(); // 0x140207C20
void AppMain::ST_TitleDraw(); // 0x140207D90//decompilation failure at 140A5F870!
//decompilation failure at 1408A0B30!
...
void __fastcall AppMain::ST_TitleDraw(AppMain *this)
{
  Graphics *v2; // rcx
  int v3; // er8
  int v4; // er9
...
void __fastcall AppMain::ST_TitleInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_00_TITLE, LoadCompleteEventTitle, a4);
  ...
  extension::SoundManager::stopBGM(v7, 1.0);
  this->m_SceneState = 0;
  this->iReserveScene = -1;
  this->m_FuncST = 14;
  this->m_FuncBT = 15;
  AppMain::SceneFunc(this, 14);
  this->m_FuncExit = 13;
}

void __fastcall AppMain::ST_TitleLoop(AppMain *this)
{
  GfxManager *v2; // rax
  GfxManager *v3; // rdi
  ...
  if ( v3->m_bQuitGFXMovie )
  {
    ...
    `GameDataInfo::getInstance'::`2'::instance.m_MenuID = MENU_ID_NONE;
    this->m_bNotificationRunning = 0;
    this->iReserveScene = -1;
    this->m_FadeST = 16;
    this->m_FuncST = 0;
    this->m_FadeExitFunc = 13;
