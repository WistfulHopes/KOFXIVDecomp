...
const char * ImageFilePath_P2Win; // 0x14088C000
const _C_CONV ImageRects_P2Win[68]; // 0x14088C010
const _C_CONV ImageRects_P1Win[68]; // 0x14088C120
const char * ImageFilePath_P1Win; // 0x14088C008
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_DEF = 0x0;
std::piecewise_construct_t std::piecewise_construct; // 0x14088B595
void BattleCallAnimationPlayerWin::readResources_EN(); // 0x1400B03D0
void BattleCallAnimationPlayerWin::drawAnimations_EN(float frame); // 0x1400B06A0//decompilation failure at 14088C000!
//decompilation failure at 14088C010!
//decompilation failure at 14088C120!
//decompilation failure at 14088C008!
//decompilation failure at 14088B595!
void __fastcall BattleCallAnimationPlayerWin::drawAnimations_EN(BattleCallAnimationPlayerWin *this, float frame)
{
  extension::AsyncStatus::Step v2; // edx
  bool v3; // zf
  extension::BasicFutureObject<Image,extension::FutureImageOption>::Body *m_ptr; // rcx
  extension::AsyncContent<Image> *v5; // rbx
  extension::AsyncStatus *p_m_status; // rcx
  Image *Myval2; // r8

  v3 = this->m_playerID == PLAYER_ID_1P;
  ...
  if ( v3 )
  {
    ...
    {
      BattleCallAnimationCommons::drawEffect_YouWin_EN(
        (BattleCallAnimationCommons *)m_ptr,
        frame,
        0i64,
        ImageRects_P1Win_0);
    }
    else
    {
      ...
      if ( (v5->m_status.m_stateFlags.m_value._My_val & 1) == 0 )
        extension::AsyncStatus::waitFor(p_m_status, v2);
      BattleCallAnimationCommons::drawEffect_YouWin_EN(
        (BattleCallAnimationCommons *)p_m_status,
        frame,
        v5->m_data._Mypair._Myval2,
        ImageRects_P1Win_0);
    }
  }
  else
  {
    ...
    {
      m_ptr = (extension::BasicFutureObject<Image,extension::FutureImageOption>::Body *)&v5->m_status;
      if ( (v5->m_status.m_stateFlags.m_value._My_val & 1) == 0 )
        extension::AsyncStatus::waitFor((extension::AsyncStatus *)m_ptr, v2);
...
void __fastcall BattleCallAnimationPlayerWin::readResources_EN(BattleCallAnimationPlayerWin *this)
{
  __int64 v2; // rax
  bool v3; // cf
  ...
  extension::BasicFutureObject<extension::exsound_detail::SoundBankImpl,void>::Body *v8; // rcx
  char *Ptr; // rcx
  char *v10; // rax
  ...
  extension::BasicFutureObject<extension::exsound_detail::SoundBankImpl,void> other; // [rsp+40h] [rbp-71h] BYREF
  extension::BasicFutureObject<extension::exsound_detail::SoundBankImpl,void> v14; // [rsp+50h] [rbp-61h] BYREF
  std::string v15; // [rsp+60h] [rbp-51h] BYREF
  std::string v16; // [rsp+80h] [rbp-31h] BYREF
  __int64 v17; // [rsp+A0h] [rbp-11h]
  std::string _Right; // [rsp+A8h] [rbp-9h] BYREF
  std::string v19; // [rsp+C8h] [rbp+17h] BYREF

  v17 = -2i64;
  this->m_imageCount = 1;
  *(_QWORD *)&other.gap0 = 1i64;
  v2 = 16i64;
  ...
  if ( v6 )
  {
    if ( this->m_playerID )
    {
      ...
      std::string::assign(&v19, "ui/battle_ui/_EN/announce/Player2_Wins_out.obm", aUiBattleUiEnAn_3[0] != 0 ? 0x2E : 0);
      v14.m_isNoCache = 0;
      v16._Mypair._Myval2._Myres = 15i64;
      v16._Mypair._Myval2._Mysize = 0i64;
      v16._Mypair._Myval2._Bx._Buf[0] = 0;
      std::string::assign(&v16, &v19, 0i64, 0xFFFFFFFFFFFFFFFFui64);
      extension::BasicFutureObject<Image,extension::FutureImageOption>::AssetCache::getCachedOrLoadStart(
        v11,
        (extension::RefCountablePtr<extension::BasicFutureObject<Image,extension::FutureImageOption>::Body> *)&v14.m_body,
        &v16,
        0i64);
      extension::BasicFutureObject<OGLSecondary,void>::operator=(
        ...
        &v14);
      m_ptr = v14.m_body.m_ptr;
      if ( v14.m_body.m_ptr
        && _InterlockedExchangeAdd64(
             (volatile signed __int64 *)&v14.m_body.m_ptr->m_refCount.m_ptr->m_sharedCount,
...
LABEL_37:
    ...
    else
    {
      ...
      std::string::assign(
        &_Right,
        "ui/battle_ui/_EN/announce/Player1_Wins_out.obm",
        aUiBattleUiEnAn_7[0] != 0 ? 0x2E : 0);
      other.m_isNoCache = 0;
      ...
      extension::BasicFutureObject<OGLSecondary,void>::operator=(
        (extension::BasicFutureObject<extension::exsound_detail::SoundBankImpl,void> *)this->m_pImages,
        &other);
      v8 = other.m_body.m_ptr;
      if ( other.m_body.m_ptr
        && _InterlockedExchangeAdd64(
             (volatile signed __int64 *)&other.m_body.m_ptr->m_refCount.m_ptr->m_sharedCount,
             0xFFFFFFFFFFFFFFFFui64) == 1 )
      {
        ((void (__fastcall *)(extension::BasicFutureObject<extension::exsound_detail::SoundBankImpl,void>::Body *, __int64))v8->~RefCountableWeakSupportBase)(
          v8,
          1i64);
      }
