...
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B19
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5E1F0
void LoadCompleteMyRanking(); // 0x1401CBF80
void AppMain::ST_MyRankingInit(); // 0x1401CC140
void AppMain::ST_MyRankingLoop(); // 0x1401CC300
void AppMain::ST_MyRankingDraw(); // 0x1401C06B0//decompilation failure at 1408A0B19!
//decompilation failure at 140A5E1F0!
void __fastcall LoadCompleteMyRanking()
{
  __int64 v0; // rbx
  int v1; // edi
  int v2; // ebx
  ...
  Scaleform::GFx::Value presult; // [rsp+38h] [rbp-59h] BYREF
  Scaleform::GFx::Value ptr; // [rsp+68h] [rbp-29h] BYREF
  Scaleform::GFx::Value val; // [rsp+98h] [rbp+7h] BYREF
  __int64 v8; // [rsp+C8h] [rbp+37h]
  GfxManager *v9; // [rsp+F8h] [rbp+67h]
  ...
  if ( *(_DWORD *)(v0 + 11108) != -1 )
  {
    if ( s_soundIndex.m_keys[246].m_sharedBuffer.m_ptr
      && !extension::SoundList::playSEByName((extension::SoundList *)(v0 + 2197144), &s_soundIndex.m_keys[246], 0i64) )
    {
      extension::SoundList::playSEByName((extension::SoundList *)(v0 + 2196904), &s_soundIndex.m_keys[246], 0i64);
    }
    v1 = *(_DWORD *)(v0 + 11108);
    if ( (ptr.Type & 0x40) != 0 )
    {
    ...
    if ( Scaleform::GFx::Movie::IsAvailable(v3->m_GFXMovie.m_movieProxy.m_ptr->m_movie.pObject, "_root.TabSetting") )
      Scaleform::GFx::Movie::Invoke(m_ptr->m_movie.pObject, "_root.TabSetting", &presult, &ptr, 2u);
  }
...
void __fastcall AppMain::ST_MyRankingInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  GfxManager *v6; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_17_MY_RANKING, LoadCompleteMyRanking, a4);
  ...
  this->m_FuncST = 74;
  this->m_FuncBT = 75;
  AppMain::SceneFunc(this, 74);
  this->m_FuncExit = 73;
}

void __fastcall AppMain::ST_MyRankingLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
