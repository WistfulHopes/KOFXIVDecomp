...
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B0A
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5D470
void AppMain::ST_FreematchMenuInit(); // 0x1401C23D0
void AppMain::ST_FreematchMenuLoop(); // 0x1401C25E0
void AppMain::ST_FreematchMenuDraw(); // 0x1401C06B0//decompilation failure at 1408A0B0A!
//decompilation failure at 140A5D470!
...
void __fastcall AppMain::ST_FreematchMenuInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_01_UI_MENU_FREEMATCH, 0i64, a4);
...
LABEL_15:
  ...
  this->m_FuncST = 134;
  this->m_FuncBT = 135;
  AppMain::SceneFunc(this, 134);
  this->m_FuncExit = 133;
}

void __fastcall AppMain::ST_FreematchMenuLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
  ...
  if ( v2->m_bQuitGFXMovie )
  {
    ...
    v6 = v4->m_MenuCursor[9];
    if ( v4->m_QuitResultCode == RESULT_CODE_CANCEL )
    {
      this->iReserveScene = -1;
      this->m_FadeST = 100;
      this->m_FuncST = 0;
      this->m_FadeExitFunc = 133;
    ...
    else
    {
      ...
      if ( v6 )
      {
        ...
        if ( v7 )
        {
          ...
          Instance->m_GameMode[Instance->m_GameModeIndex] = GAME_MODE_FREEMATCH;
          v9 = GameDataInfo::getInstance();
          v9->m_GameRule[v9->m_GameRuleIndex] = GAME_RULE_PARTY;
        }
        else
        {
          this->MatchingGameRule = GAME_RULE_SINGLE;
          v10 = GameDataInfo::getInstance();
          v10->m_GameMode[v10->m_GameModeIndex] = GAME_MODE_FREEMATCH;
      ...
      else
      {
        ...
        v12->m_GameMode[v12->m_GameModeIndex] = GAME_MODE_FREEMATCH;
        v13 = GameDataInfo::getInstance();
        v13->m_GameRule[v13->m_GameRuleIndex] = GAME_RULE_TEAM;
      }
      v14 = GameDataInfo::getInstance();
      GameDataInfo::SetDefaultSettingSaveData(v14);
      AppMain::setNonFadeSTExit(this, 136, 133);
    }
  }
}
