...
std::piecewise_construct_t std::piecewise_construct; // 0x14088B590
const char * ImageFilePath_Complete; // 0x14088B598
const `anonymous-namespace'::<unnamed-enum-COMPLETE_EFF_LINE> `anonymous namespace'::COMPLETE_EFF_LINE = 0x0;
const `anonymous-namespace'::<unnamed-enum-COMPLETE_EFF_LINE> `anonymous namespace'::COMPLETE_EFF_COMPLETE_BURST = 0x2;
const _C_CONV ImageRects_Complete[16]; // 0x14088B5A0
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_DEF = 0x0;
const `anonymous-namespace'::<unnamed-enum-COMPLETE_EFF_LINE> `anonymous namespace'::COMPLETE_COMPLETE = 0x1;
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_MAX = 0x1;
void BattleCallAnimationComplete::readResources_EN(); // 0x1400AB570
void BattleCallAnimationComplete::drawAnimations_EN(float frame); // 0x1400AB790//decompilation failure at 14088B590!
//decompilation failure at 14088B598!
//decompilation failure at 14088B5A0!
void __fastcall BattleCallAnimationComplete::drawAnimations_EN(BattleCallAnimationComplete *this, float frame)
{
  ...
  Tween::EasingType aniFrame2c; // [rsp+40h] [rbp-138h]
  int aniFrame2d; // [rsp+40h] [rbp-138h]
  Tween::EasingType aniFrame2e; // [rsp+40h] [rbp-138h]
  int aniFrame2f; // [rsp+40h] [rbp-138h]
  int aniFrame2b; // [rsp+40h] [rbp-138h]
  Tween::EasingType aniFrame2g; // [rsp+40h] [rbp-138h]
  int aniFrame2h; // [rsp+40h] [rbp-138h]
  ...
  float outParams2; // [rsp+1C8h] [rbp+50h] BYREF
  float outParam; // [rsp+1D0h] [rbp+58h] BYREF
  float outParams1; // [rsp+1D8h] [rbp+60h] BYREF
  float x; // [rsp+1E0h] [rbp+68h] BYREF
...
LABEL_17:
      ...
      v8 = Tween::easing(1.0, 0.0, (float)(frame - 40.0) / 6.0, Linear);
    }
    else
    {
      v8 = *(float *)&FLOAT_1_0;
...
LABEL_18:
    v9 = *(Graphics **)(v3 + 8);
    outParam = v8;
    Graphics::setRenderMode(v9, 3, (int)(float)(v8 * 255.0));
    v10 = outParams2;
    v11 = outParams1;
    drawConv(Myval2, 960.0, 540.0, &ImageRects_Complete_0[1], outParams1, outParams2, 0.0, aniFrame2a);
    easing(&outParam, frame, 5.0, 1.0, p11a, 8.0, 0.2, aniFrame2c, 37.0, 0.5, type2a, 43.0, 1.0, p32a, 49.0, 0.0);
    Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, (int)(float)(outParam * 255.0));
    drawConv(Myval2, 960.0, 540.0, &ImageRects_Complete_0[1], v11, v10, 0.0, aniFrame2d);
    p61 = *(float *)&FLOAT_44_0;
    easing(
      &outParams1,
      &outParams2,
      frame,
      ...
      FLOAT_1_5,
      0.0);
    easing(&outParam, frame, 5.0, 1.0, p11b, 8.0, 0.1, aniFrame2e, 37.0, 1.0, type2c, 43.0, 1.0, p32c, 49.0, 0.0);
    Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, (int)(float)(outParam * 255.0));
    drawConv(Myval2, 960.0, 540.0, &ImageRects_Complete_0[2], outParams1, outParams2, 0.0, aniFrame2f);
    goto LABEL_20;
  }
  p61 = *(float *)&FLOAT_44_0;
LABEL_20:
  easing(&x, frame, 0.0, -558.0, p11, 5.0, 960.0, aniFrame2, 43.0, 960.0, type2, 45.0, 1504.0, p32, 48.0, 2720.0);
  if ( frame < 0.0 )
  {
    v13 = *(float *)&FLOAT_1_0;
  }
  ...
  {
    easing(&outParam, frame, 0.0, 0.69999999, FLOAT_5_0, 0.5, 10.0, Linear, 43.0, 0.0, FLOAT_44_0, 0.5, 48.0, FLOAT_1_0);
    v14 = outParam;
  }
  v15 = (int)(float)(v14 * 255.0);
  Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, v15);
  drawConv(Myval2, x, 540.0, ImageRects_Complete_0, v13, v6, 0.0, aniFrame2b);
  easing(&x, frame, 0.0, 2498.0, p11c, 5.0, 960.0, aniFrame2g, 43.0, 960.0, type2b, 45.0, 436.0, p32b, 48.0, -800.0);
  Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, v15);
  drawConv(Myval2, x, 540.0, ImageRects_Complete_0, v13, v6, 0.0, aniFrame2h);
}

void __fastcall BattleCallAnimationComplete::readResources_EN(BattleCallAnimationComplete *this)
{
  __int64 v2; // rax
  bool v3; // cf
  ...
  if ( p_m_refCount )
  {
    ...
    std::string::assign(&_Right, "ui/battle_ui/_EN/announce/Complete_out.obm", aUiBattleUiEnAn_11[0] != 0 ? 0x2A : 0);
