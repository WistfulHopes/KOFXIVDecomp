...
const char * ImageFilePath_TimeUp; // 0x14088C3E8
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_DEF = 0x0;
const `anonymous-namespace'::<unnamed-enum-TIMEUP_EFF_LINE> `anonymous namespace'::TIMEUP_TIMEUP = 0x1;
const `anonymous-namespace'::<unnamed-enum-IMAGEID_DEF> `anonymous namespace'::IMAGEID_MAX = 0x1;
const `anonymous-namespace'::<unnamed-enum-TIMEUP_EFF_LINE> `anonymous namespace'::TIMEUP_EFF_LINE = 0x0;
const _C_CONV ImageRects_TimeUp[16]; // 0x14088C3F0
const `anonymous-namespace'::<unnamed-enum-TIMEUP_EFF_LINE> `anonymous namespace'::TIMEUP_EFF_TIMEUP = 0x2;
std::piecewise_construct_t std::piecewise_construct; // 0x14088B597
void BattleCallAnimationTimeUp::readResources_EN(); // 0x1400B3840
void BattleCallAnimationTimeUp::drawAnimations_EN(float frame); // 0x1400B3A60//decompilation failure at 14088C3E8!
//decompilation failure at 14088C3F0!
//decompilation failure at 14088B597!
void __fastcall BattleCallAnimationTimeUp::drawAnimations_EN(BattleCallAnimationTimeUp *this, float frame)
{
  ...
  float v16; // xmm0_4
  int v17; // ebx
  Tween::EasingType p11; // [rsp+28h] [rbp-120h]
  Tween::EasingType p11a; // [rsp+28h] [rbp-120h]
  int aniFrame2; // [rsp+40h] [rbp-108h]
  int aniFrame2a; // [rsp+40h] [rbp-108h]
  int aniFrame2b; // [rsp+40h] [rbp-108h]
  Tween::EasingType aniFrame2d; // [rsp+40h] [rbp-108h]
  int aniFrame2c; // [rsp+40h] [rbp-108h]
  Tween::EasingType aniFrame2e; // [rsp+40h] [rbp-108h]
  int aniFrame2f; // [rsp+40h] [rbp-108h]
  Tween::EasingType type2; // [rsp+58h] [rbp-F0h]
  Tween::EasingType type2a; // [rsp+58h] [rbp-F0h]
  Tween::EasingType p32; // [rsp+70h] [rbp-D8h]
  Tween::EasingType p32a; // [rsp+70h] [rbp-D8h]
  float outParams2; // [rsp+198h] [rbp+50h] BYREF
  float outParam; // [rsp+1A0h] [rbp+58h] BYREF
  float outParams1; // [rsp+1A8h] [rbp+60h] BYREF
  float x; // [rsp+1B0h] [rbp+68h] BYREF
  ...
  if ( frame < 5.0 )
  {
    LODWORD(outParams1) = FLOAT_1_3;
    v8 = *(float *)&FLOAT_1_3;
    LODWORD(outParams2) = FLOAT_1_3;
    v7 = *(float *)&FLOAT_1_3;
  }
  else
  {
  ...
  else
  {
    ...
    if ( frame <= 64.0 )
    {
      v10 = Tween::easing(0.0, 0.0, (float)(frame - 61.0) / 3.0, Linear);
      outParam = v10;
      goto LABEL_25;
    }
  }
  outParam = 0.0;
LABEL_25:
  Graphics::setRenderMode(*(Graphics **)(v3 + 8), 3, (int)(float)(v10 * 255.0));
  drawConv(Myval2, 960.0, 540.0, &ImageRects_TimeUp_0[1], v8, v7, 0.0, aniFrame2);
  if ( frame < 4.0 )
  {
    outParam = 0.0;
    v11 = 0.0;
  ...
  {
    easing(&outParam, frame, 4.0, 0.0, FLOAT_5_0, 1.0, 8.0, FLOAT_0_2, 52.0, 0.5, FLOAT_58_0, 1.0, 64.0, Linear);
    v11 = outParam;
  }
  Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, (int)(float)(v11 * 255.0));
  drawConv(Myval2, 960.0, 540.0, &ImageRects_TimeUp_0[1], v8, v7, 0.0, aniFrame2a);
  if ( frame < 5.0 )
  {
    LODWORD(outParams1) = FLOAT_1_3;
    v12 = *(float *)&FLOAT_1_3;
  ...
  {
    easing(&outParam, frame, 4.0, 0.0, FLOAT_5_0, 1.0, 8.0, FLOAT_0_1, 52.0, 1.0, FLOAT_58_0, 1.0, 64.0, Linear);
    v14 = outParam;
  }
  Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, (int)(float)(v14 * 255.0));
  drawConv(Myval2, 960.0, 540.0, &ImageRects_TimeUp_0[2], v12, v6, 0.0, aniFrame2b);
  easing(&x, frame, 0.0, -558.0, p11, 5.0, 960.0, aniFrame2d, 58.0, 960.0, type2, 60.0, 1504.0, p32, 63.0, 2720.0);
  if ( frame < 0.0 )
  {
    v15 = *(float *)&FLOAT_1_0;
  }
  ...
  v17 = (int)(float)(v16 * 255.0);
  Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, v17);
  drawConv(Myval2, x, 540.0, ImageRects_TimeUp_0, v15, v13, 0.0, aniFrame2c);
  easing(&x, frame, 0.0, 2498.0, p11a, 5.0, 960.0, aniFrame2e, 58.0, 960.0, type2a, 60.0, 436.0, p32a, 63.0, -800.0);
  Graphics::setRenderMode(*(Graphics **)(v3 + 8), 1, v17);
  drawConv(Myval2, x, 540.0, ImageRects_TimeUp_0, v15, v13, 0.0, aniFrame2f);
}

void __fastcall BattleCallAnimationTimeUp::readResources_EN(BattleCallAnimationTimeUp *this)
{
  __int64 v2; // rax
  bool v3; // cf
  ...
  if ( p_m_refCount )
  {
    ...
    std::string::assign(&_Right, "ui/battle_ui/_EN/announce/TimeUp_out.obm", aUiBattleUiEnAn[0] != 0 ? 0x28 : 0);
