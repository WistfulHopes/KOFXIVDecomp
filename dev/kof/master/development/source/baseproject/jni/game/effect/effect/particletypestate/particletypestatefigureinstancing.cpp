...
std::piecewise_construct_t std::piecewise_construct; // 0x14089E394
void ParticleTypeStateFigureInstancing::loadFigure(const char * filename); // 0x14014DD80
void ParticleTypeStateFigureInstancing::UpdateVertexBuffer(EffectUpdateBufferArgument * pUpdateBufferArg); // 0x14014DD90
void ParticleTypeStateFigureInstancing::Render(EffectRenderArgument * pRenderArg); // 0x14014DDC0//decompilation failure at 14089E394!
void __fastcall ParticleTypeStateFigureInstancing::Render(
        ParticleTypeStateFigureInstancing *this,
        EffectRenderArgument *pRenderArg)
{
  ...
  if ( ((unsigned __int8 (__fastcall *)(ParticleTypeStateFigureInstancing *, EffectData *, _QWORD))this->RenderErrorCheck)(
         this,
    ...
    && this->m_FigureData )
  {
    ...
    if ( pRenderArg->pParticleDataVec->_Mypair._Myval2._Mylast - pRenderArg->pParticleDataVec->_Mypair._Myval2._Myfirst )
    {
      ...
      OGLRender::drawEffectIndexInstancesUVAnime(
        ...
        &this->m_TextureData,
        &this->m_EffectMeshData[v6],
        &this->m_EffectConstData);
    }
  }
}

void __fastcall ParticleTypeStateFigureInstancing::UpdateVertexBuffer(
        ParticleTypeStateFigureInstancing *this,
        EffectUpdateBufferArgument *pUpdateBufferArg)
{
  this->m_pParticleEmitter->renderFlag = this->UpdateVertexBufferInstancing(this, pUpdateBufferArg);
}
