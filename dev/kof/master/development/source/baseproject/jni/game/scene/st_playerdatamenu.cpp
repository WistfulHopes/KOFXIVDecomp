...
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5E8B0
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B1F
void AppMain::ST_PlayerDataMenuInit(); // 0x1401CFD70
void AppMain::ST_PlayerDataMenuLoop(); // 0x1401CFE60
void AppMain::ST_PlayerDataMenuDraw(); // 0x1401C06B0//decompilation failure at 140A5E8B0!
//decompilation failure at 1408A0B1F!
...
void __fastcall AppMain::ST_PlayerDataMenuInit(AppMain *this, __int64 a2, __int64 a3, int a4)
{
  GfxManager *v5; // rax
  ...
  GfxManager::LoadRequest(v5, FILE_01_UI_MENU_PLAYERDATA, 0i64, a4);
  ...
  this->m_FuncST = 62;
  this->m_FuncBT = 63;
  AppMain::SceneFunc(this, 62);
  this->m_FuncExit = 61;
}

void __fastcall AppMain::ST_PlayerDataMenuLoop(AppMain *this)
{
  GfxManager *v2; // rdi
  GfxManager *v3; // rax
  GfxManager *v4; // rax
  ...
  if ( v2->m_bQuitGFXMovie )
  {
    ...
    v6 = v4->m_MenuCursor[4];
    if ( v4->m_QuitResultCode == RESULT_CODE_CANCEL )
    {
      this->iReserveScene = -1;
      this->m_FadeST = 16;
      this->m_FuncST = 0;
      this->m_FadeExitFunc = 61;
    ...
    else
    {
      if ( v6 )
      {
        ...
        if ( v7 )
        {
          ...
          if ( !v8 )
          {
            AppMain::setNonFadeSTExit(this, 76, 61);
            this->m_PrevScene = 60;
            return;
          }
          v9 = v8 - 1;
      ...
      AppMain::setNonFadeSTExit(this, v10, 61);
    }
  }
}
