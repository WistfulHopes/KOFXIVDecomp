...
std::piecewise_construct_t std::piecewise_construct; // 0x1408A06FA
bool AppMain::CheckGradeSkipEnd(); // 0x1401A6E80//decompilation failure at 1408A06FA!
bool __fastcall AppMain::CheckGradeSkipEnd(AppMain *this)
{
  unsigned int v2; // er8
  bool result; // al
  ...
  if ( (int)((v2 ^ (v2 >> 7)) & 0x550055 ^ v2 ^ (((v2 ^ (v2 >> 7)) & 0x550055) << 7)) < 10 )
    return 0;
  AppMain::SetBattleGradeForSkipGradeSaveData(this);
  this->SaveDataMain.GameData.m_FirstNoticeFlag.m_Flag[0] &= ~0x20000000u;
  result = 1;
  this->SaveDataMain.PlayerData.m_SkipRankMatchRank = 0;
  return result;
}
