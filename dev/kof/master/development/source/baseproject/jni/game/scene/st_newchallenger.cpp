...
std::piecewise_construct_t std::piecewise_construct; // 0x1408A0B1A
const AgDisplayMode fixedAspectRatioModes[72]; // 0x140A5E310
void AppMain::ST_NewChallengerInit(); // 0x1401CC420
void AppMain::ST_NewChallengerLoop(); // 0x1401CC6B0
void AppMain::ST_NewChallengerDraw(); // 0x1401CC880
bool AppMain::InputCheckNewChallenger(bool contSelect); // 0x1401CC9B0
bool AppMain::InputCheckNewChallengerTraining(); // 0x1401CCD40//decompilation failure at 1408A0B1A!
//decompilation failure at 140A5E310!
bool __fastcall AppMain::InputCheckNewChallenger(AppMain *this, bool contSelect)
{
  GameDataInfo *v4; // rcx
  int v5; // ebp
  __int64 v6; // rdi
  ...
  int userIndex; // edi
  FighterOperation::Slot *v26; // rax
  Framework::Input::ButtonEventPattern v27; // er8
  int v28; // esi
  int i; // ebx
  ...
  __int64 v35; // rcx
  int v36[2]; // [rsp+20h] [rbp-78h] BYREF
  __int64 v37; // [rsp+28h] [rbp-70h]
  GfxManager *v38; // [rsp+30h] [rbp-68h]
  __int128 v39; // [rsp+38h] [rbp-60h]
  __int128 v40; // [rsp+48h] [rbp-50h] BYREF
  __int128 v41[4]; // [rsp+58h] [rbp-40h]
  ...
  if ( !contSelect )
  {
    ...
    if ( m_slots )
      ...
      userIndex = 0;
    v26 = &FighterOperation::Instance()->m_slots[1];
    if ( v26 )
      v28 = v26->userIndex;
    else
      v28 = 0;
    ...
    if ( Framework::GLManager::glm->m_controllerContext.m_lastUsedContType == AgControllerType_Gamepad )
    {
      for ( i = 1; i <= 2; ++i )
      {
        if ( i != userIndex && i != v28 && UserGameOperation::Test(i, GameOp_GameStart, Test_OnEdge) )
        {
          Instance = GameDataInfo::getInstance();
          v31 = 649i64;
          if ( userIndex )
            v31 = 650i64;
          Instance->randMT.mt[v31] = i;
          this->m_RequestCupture = 1;
          return 1;
        }
      }
    }
    else if ( Framework::Input::ControllerContext::isKeyboardButtonPressedNoRepeat(
                &Framework::GLManager::glm->m_controllerContext,
                0x71u,
                v27) )
    {
      LOBYTE(v23) = userIndex == 1;
      v33 = v23 + 1;
      v34 = GameDataInfo::getInstance();
      v35 = 649i64;
      if ( userIndex )
        v35 = 650i64;
      v34->randMT.mt[v35] = v33;
      goto LABEL_67;
    }
    return 0;
  }
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned __int64)(v6 - 1) <= 3 )
    {
      ...
      {
        v11 = *(_DWORD *)(v7 + *(_QWORD *)&AppMain::pApp + 2198556);
        if ( v11 )
        {
          v12 = 0;
          ...
          {
            ++v12;
            if ( j->m_commandBufferSyncLazyFuncQueue._Mypair._Myval2._Myproxy && v12 == v11 )
            {
              if ( v12 == -1 )
                break;
...
LABEL_22:
    p_m_anyUserSlot = &v9->m_anyUserSlot;
    if ( v5 != 0x80000000 )
...
LABEL_41:
  ...
  v15 = &v9->m_ButtonConfig[12];
  v36[0] = 0xFFFF;
  v16 = 0i64;
  while ( *(int *)((char *)&v36[v16] + (char *)&v9->m_ButtonConfig[12] - (char *)v36) == v36[v16] )
  {
    if ( --v16 < 0 )
      goto LABEL_33;
  }
  v36[0] = v15->_Array[0] & p_m_anyUserSlot->m_pressedEventChannels._Array[0];
  v17 = 0i64;
  v18 = (char *)v15 - (char *)v36;
  while ( v36[v17] == *(int *)((char *)&v36[v17] + v18) )
  {
    if ( --v17 < 0 )
      goto LABEL_67;
  }
LABEL_33:
  ...
  if ( v5 == 2 )
    v19 = 633i64;
  v39 = *(_OWORD *)&v9->m_slots[0].m_stableKeyboardChannels._Array[v19];
  v40 = *(_OWORD *)&v9->m_slots[0].m_stableKeyboardChannels._Array[v19 + 2];
  v20 = 3i64;
  v21 = (char *)p_m_anyUserSlot - ((char *)&v40 + 8);
  do
  {
    *((_QWORD *)&v39 + v20) &= *(_QWORD *)((char *)&v41[3] + 8 * v20 + v21 + 8);
    --v20;
  }
  while ( v20 >= 0 );
  v41[0] = v39;
...
char __fastcall AppMain::InputCheckNewChallengerTraining(AppMain *this)
{
  __int64 v2; // rdx
  const char *v3; // rcx
  GameDataInfo *v5; // rcx
  ...
  if ( !Fw::MatchingTarget::IsRoomOwner(v3, v2) || g_NetworkManager.gamedata.roomPlayerCount < 2u )
    return 0;
  this->m_RequestCupture = 1;
  return 1;
}

void __fastcall AppMain::ST_NewChallengerDraw(AppMain *this)
{
  Graphics *v2; // rcx
  Graphics *g; // rdx
  GfxManager *v4; // rax
...
void __fastcall AppMain::ST_NewChallengerInit(AppMain *this)
{
  UserGameOperation *v2; // rax
  GfxManager *v3; // rax
  ...
  GfxManager *v9; // rax
  extension::gfxi_detail::MovieProxy *v10; // rdi
  int v11; // ecx
  GfxManager *v12; // [rsp+50h] [rbp+8h]
  GfxManager *v13; // [rsp+50h] [rbp+8h]
  GfxManager *v14; // [rsp+50h] [rbp+8h]
  extension::SoundManager *v15; // [rsp+50h] [rbp+8h]
  GfxManager *v16; // [rsp+50h] [rbp+8h]

  v2 = UserGameOperation::Instance();
  UserGameOperation::clear(v2);
  ...
  {
    v3->m_GFXMovie.m_movieProxy.m_ptr->m_bAdvance = 0;
    if ( v3->m_GFXMovie.m_movieProxy.m_ptr )
      v3->m_GFXMovie.m_movieProxy.m_ptr->m_bRender = 0;
  }
  if ( !v3 )
  {
  ...
  if ( v3->m_GFXMovieBG.m_movieProxy.m_ptr )
  {
    m_ptr = v3->m_GFXMovieBG.m_movieProxy.m_ptr;
    if ( m_ptr )
      m_ptr->m_bAdvance = 0;
    v5 = v3->m_GFXMovieBG.m_movieProxy.m_ptr;
    if ( v5 )
      v5->m_bRender = 0;
  }
  if ( !v3 )
  ...
  if ( v3->m_GFXMovieNotification.m_movieProxy.m_ptr )
  {
    ...
    if ( v6 )
      v6->m_bAdvance = 1;
    v7 = v3->m_GFXMovieNotification.m_movieProxy.m_ptr;
    if ( v7 )
      v7->m_bRender = 1;
  }
  else
  ...
  {
    v15 = (extension::SoundManager *)operator new(0x310ui64);
    extension::SoundManager::SoundManager(v15);
    extension::SoundManager::the_instance = v8;
  }
  extension::SoundManager::stopBGM(v8, 1.5);
  SyncMenuImage::Load(
    &this->m_SyncMenuBG,
  ...
  v10 = v9->m_GFXMovieNotification.m_movieProxy.m_ptr;
  if ( v10 && Scaleform::GFx::Movie::IsAvailable(v10->m_movie.pObject, "_root.NewChallenger") )
    Scaleform::GFx::Movie::Invoke(v10->m_movie.pObject, "_root.NewChallenger", 0i64, 0i64, 0);
  if ( this->m_iFadeAlpha )
  {
    this->m_bFadeEnd = 0;
    this->m_iFadeFrame = 10;
    v11 = 1000 * this->m_iFadeColor.s.a;
    this->m_iFadeAlpha = v11;
    this->m_iFadeRate = v11 / 10;
    this->m_bFadeLock = 0;
    this->m_FuncFT = 171;
  }
  ...
  this->m_FuncST = 126;
  this->m_FuncBT = 127;
  AppMain::SceneFunc(this, 126);
  this->m_FuncExit = 125;
}

void __fastcall AppMain::ST_NewChallengerLoop(AppMain *this)
{
  GfxManager *v2; // rax
  GfxManager *v3; // rdi
  ...
  GfxManager *v6; // rax
  int v7; // ecx
  GfxManager *v8; // [rsp+48h] [rbp+10h]
  GfxManager *v9; // [rsp+48h] [rbp+10h]
  GfxManager *v10; // [rsp+48h] [rbp+10h]
  ...
  if ( v3->m_bQuitGFXMovie )
  {
    ...
    *(_QWORD *)&this->m_iFadeColor.rgba = 255i64;
    ...
    this->m_FuncFT = 170;
    this->m_bFadeLock = 0;
    this->m_iFadeRate = v7 / 6;
    this->m_iFadeFrame = 6;
    *(_WORD *)&this->m_bFadeEnd = 0;
    this->m_FadeExitFunc = 125;
    this->m_FuncST = 0;
    this->iReserveScene = -1;
  }
}
